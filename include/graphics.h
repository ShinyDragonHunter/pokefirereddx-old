...
extern const u32 gTrainerFrontPic_HoennPokemonBreederF[];
extern const u32 gTrainerFrontPic_HoennCooltrainerM[];
extern const u32 gTrainerFrontPic_HoennBirdKeeper[];
extern const u32 gTrainerFrontPic_HoennCollector[];
extern const u32 gTrainerFrontPic_HoennSwimmerM[];
extern const u32 gTrainerFrontPic_HoennExpertM[];
extern const u32 gTrainerFrontPic_HoennBlackBelt[];
extern const u32 gTrainerFrontPic_HoennHexManiac[];
extern const u32 gTrainerFrontPic_HoennAromaLady[];
extern const u32 gTrainerFrontPic_HoennRuinManiac[];
extern const u32 gTrainerFrontPic_HoennTuberF[];
extern const u32 gTrainerFrontPic_HoennTuberM[];
extern const u32 gTrainerFrontPic_HoennCooltrainerF[];
extern const u32 gTrainerFrontPic_HoennLady[];
extern const u32 gTrainerFrontPic_HoennBeauty[];
extern const u32 gTrainerFrontPic_HoennRichBoy[];
extern const u32 gTrainerFrontPic_HoennExpertF[];
extern const u32 gTrainerFrontPic_HoennPokemaniac[];
extern const u32 gTrainerFrontPic_HoennGuitarist[];
extern const u32 gTrainerFrontPic_HoennKindler[];
extern const u32 gTrainerFrontPic_HoennCamper[];
extern const u32 gTrainerFrontPic_HoennPicnicker[];
extern const u32 gTrainerFrontPic_HoennBugManiac[];
extern const u32 gTrainerFrontPic_HoennPokemonBreederM[];
extern const u32 gTrainerFrontPic_HoennPsychicM[];
extern const u32 gTrainerFrontPic_HoennPsychicF[];
extern const u32 gTrainerFrontPic_HoennGentleman[];
extern const u32 gTrainerFrontPic_HoennSchoolKidM[];
extern const u32 gTrainerFrontPic_HoennSchoolKidF[];
extern const u32 gTrainerFrontPic_HoennPokefanM[];
extern const u32 gTrainerFrontPic_HoennPokefanF[];
extern const u32 gTrainerFrontPic_HoennYoungster[];
extern const u32 gTrainerFrontPic_HoennFisherman[];
extern const u32 gTrainerFrontPic_HoennCyclingTriathleteM[];
extern const u32 gTrainerFrontPic_HoennCyclingTriathleteF[];
extern const u32 gTrainerFrontPic_HoennRunningTriathleteM[];
extern const u32 gTrainerFrontPic_HoennRunningTriathleteF[];
extern const u32 gTrainerFrontPic_HoennSwimmingTriathleteM[];
extern const u32 gTrainerFrontPic_HoennSwimmingTriathleteF[];
extern const u32 gTrainerFrontPic_HoennDragonTamer[];
extern const u32 gTrainerFrontPic_HoennNinjaBoy[];
extern const u32 gTrainerFrontPic_HoennBattleGirl[];
extern const u32 gTrainerFrontPic_HoennParasolLady[];
extern const u32 gTrainerFrontPic_HoennSwimmerF[];
extern const u32 gTrainerFrontPic_HoennSailor[];
extern const u32 gTrainerFrontPic_Wally[];
extern const u32 gTrainerFrontPic_EBrendan[];
extern const u32 gTrainerFrontPic_EMay[];
extern const u32 gTrainerFrontPic_HoennBugCatcher[];
extern const u32 gTrainerFrontPic_HoennPokemonRangerM[];
extern const u32 gTrainerFrontPic_HoennPokemonRangerF[];
extern const u32 gTrainerFrontPic_HoennLass[];
...
extern const u32 gTrainerFrontPic_RSBrendan[];
extern const u32 gTrainerFrontPic_RSMay[];
...
extern const u32 gTrainerFrontPic_RedDX[];
extern const u32 gTrainerFrontPic_LeafDX[];
extern const u32 gTrainerFrontPic_RedClassic[];
extern const u32 gTrainerFrontPic_LeafClassic[];
extern const u32 gTrainerFrontPic_RedAlola[];
extern const u32 gTrainerFrontPic_LeafAlola[];
extern const u32 gTrainerFrontPic_RedSygnaSuit[];
extern const u32 gTrainerFrontPic_LeafSygnaSuit[];
extern const u32 gTrainerFrontPic_RedTeamRocket[];
extern const u32 gTrainerFrontPic_LeafTeamRocket[];
extern const u32 gTrainerFrontPic_RedTeamAqua[];
extern const u32 gTrainerFrontPic_LeafTeamAqua[];
extern const u32 gTrainerFrontPic_RedTeamMagma[];
extern const u32 gTrainerFrontPic_LeafTeamMagma[];
extern const u32 gTrainerFrontPic_FanClubPresident[];
...
extern const u16 gTrainerPalette_HoennHiker[];
extern const u16 gTrainerPalette_Firebreather[];
extern const u16 gTrainerPalette_HoennPokemonBreederF[];
extern const u16 gTrainerPalette_HoennCooltrainerM[];
extern const u16 gTrainerPalette_HoennBirdKeeper[];
extern const u16 gTrainerPalette_HoennCollector[];
extern const u16 gTrainerPalette_HoennSwimmerM[];
extern const u16 gTrainerPalette_HoennExpert[];
extern const u16 gTrainerPalette_HoennBlackBelt[];
extern const u16 gTrainerPalette_HoennHexManiac[];
extern const u16 gTrainerPalette_HoennAromaLady[];
extern const u16 gTrainerPalette_HoennRuinManiac[];
extern const u16 gTrainerPalette_HoennTuber[];
extern const u16 gTrainerPalette_HoennCooltrainerF[];
extern const u16 gTrainerPalette_HoennLady[];
extern const u16 gTrainerPalette_HoennBeauty[];
extern const u16 gTrainerPalette_HoennRichBoy[];
extern const u16 gTrainerPalette_HoennPokemaniac[];
extern const u16 gTrainerPalette_HoennGuitarist[];
extern const u16 gTrainerPalette_HoennKindler[];
extern const u16 gTrainerPalette_HoennCamper[];
extern const u16 gTrainerPalette_HoennPicnicker[];
extern const u16 gTrainerPalette_HoennBugManiac[];
extern const u16 gTrainerPalette_HoennPokemonBreederM[];
extern const u16 gTrainerPalette_HoennPsychicM[];
extern const u16 gTrainerPalette_HoennPsychicF[];
extern const u16 gTrainerPalette_HoennGentleman[];
extern const u16 gTrainerPalette_HoennSchoolKidM[];
extern const u16 gTrainerPalette_HoennSchoolKidF[];
extern const u16 gTrainerPalette_HoennPokefanM[];
extern const u16 gTrainerPalette_HoennPokefanF[];
extern const u16 gTrainerPalette_HoennYoungster[];
extern const u16 gTrainerPalette_HoennFisherman[];
extern const u16 gTrainerPalette_HoennCyclingTriathleteM[];
extern const u16 gTrainerPalette_HoennCyclingTriathleteF[];
extern const u16 gTrainerPalette_HoennRunningTriathleteM[];
extern const u16 gTrainerPalette_HoennRunningTriathleteF[];
extern const u16 gTrainerPalette_HoennSwimmingTriathleteM[];
extern const u16 gTrainerPalette_HoennSwimmingTriathleteF[];
extern const u16 gTrainerPalette_HoennDragonTamer[];
extern const u16 gTrainerPalette_HoennNinjaBoy[];
extern const u16 gTrainerPalette_HoennBattleGirl[];
extern const u16 gTrainerPalette_HoennParasolLady[];
extern const u16 gTrainerPalette_HoennSwimmerF[];
extern const u16 gTrainerPalette_HoennSailor[];
extern const u16 gTrainerPalette_Wally[];
extern const u16 gTrainerPalette_EBrendan[];
extern const u16 gTrainerPalette_EMay[];
extern const u16 gTrainerPalette_HoennBugCatcher[];
extern const u16 gTrainerPalette_HoennPokemonRangerM[];
extern const u16 gTrainerPalette_HoennPokemonRangerF[];
extern const u16 gTrainerPalette_HoennLass[];
...
extern const u16 gTrainerPalette_HBrendan[];
extern const u16 gTrainerPalette_HMay[];
...
extern const u16 gTrainerPalette_Psychic[];
...
extern const u16 gTrainerPalette_Rival[];
extern const u16 gTrainerPalette_Scientist[];
extern const u16 gTrainerPalette_LeaderGiovanni[];
extern const u16 gTrainerPalette_RocketGrunt[];
extern const u16 gTrainerPalette_Cooltrainer[];
...
extern const u16 gTrainerPalette_RSBrendan[];
extern const u16 gTrainerPalette_RSMay[];
extern const u16 gTrainerPalette_RedLeafOriginal[];
...
extern const u16 gTrainerPalette_PokemonRanger[];
...
extern const u16 gTrainerPalette_RedLeafDX[];
extern const u16 gTrainerPalette_RedLeafClassic[];
extern const u16 gTrainerPalette_RedLeafAlola[];
extern const u16 gTrainerPalette_RedLeafSygnaSuit[];
extern const u16 gTrainerPalette_RedLeafTeamRocket[];
extern const u16 gTrainerPalette_RedLeafTeamAqua[];
extern const u16 gTrainerPalette_RedLeafTeamMagma[];
extern const u16 gTrainerPalette_FanClubPresident[];
extern const u16 gTrainerPalette_RocketAdminArcher[];
extern const u16 gTrainerPalette_RocketAdminProton[];
extern const u16 gTrainerPalette_RocketAdminPetrel[];
extern const u16 gTrainerPalette_Daisy[];
extern const u16 gTrainerPalette_Bill[];
extern const u16 gTrainerPalette_MrFuji[];
extern const u16 gTrainerPalette_Scott[];

extern const u8 gTrainerBackPic_RedOriginal[];
extern const u8 gTrainerBackPic_LeafOriginal[];
extern const u8 gTrainerBackPic_PokeDude[];
extern const u8 gTrainerBackPic_OldMan[];
extern const u8 gTrainerBackPic_EBrendan[];
extern const u8 gTrainerBackPic_EMay[];
...
extern const u8 gTrainerBackPic_RedDX[];
extern const u8 gTrainerBackPic_LeafDX[];
extern const u8 gTrainerBackPic_RedClassic[];
extern const u8 gTrainerBackPic_LeafClassic[];
extern const u8 gTrainerBackPic_RedAlola[];
extern const u8 gTrainerBackPic_LeafAlola[];
extern const u8 gTrainerBackPic_RedSygnaSuit[];
extern const u8 gTrainerBackPic_LeafSygnaSuit[];
extern const u8 gTrainerBackPic_RedTeamRocket[];
extern const u8 gTrainerBackPic_LeafTeamRocket[];
extern const u8 gTrainerBackPic_RedTeamAqua[];
extern const u8 gTrainerBackPic_LeafTeamAqua[];
extern const u8 gTrainerBackPic_RedTeamMagma[];
extern const u8 gTrainerBackPic_LeafTeamMagma[];

extern const u16 gTrainerBackPicPalette_RedLeafOriginal[];
extern const u16 gTrainerBackPicPalette_PokeDude[];
extern const u16 gTrainerBackPicPalette_OldMan[];

extern const u16 gTrainerBackPicPalette_Kris[];

extern const u16 gTrainerBackPicPalette_RedLeaf[];
extern const u16 gTrainerBackPicPalette_RedLeafDX[];
extern const u16 gTrainerBackPicPalette_RedLeafAlola[];
extern const u16 gTrainerBackPicPalette_RedLeafSygnaSuit[];
extern const u16 gTrainerBackPicPalette_RedLeafTeamRocket[];
extern const u16 gTrainerBackPicPalette_RedLeafTeamAqua[];
extern const u16 gTrainerBackPicPalette_RedLeafTeamMagma[];
