...
extern const u32 gMonFrontPic_MewtwoArmored[];
extern const u32 gMonBackPic_MewtwoArmored[];
extern const u8 gMonIcon_MewtwoArmored[];
...
extern const u16 gMonShinyPalette_LugiaShadow[];
...
extern const u32 gTrainerFrontPicProton[];
extern const u32 gTrainerFrontPicPetrel[];
extern const u32 gTrainerFrontPicArcher[];
...
extern const u32 gTrainerFrontPicAriana[];
...
extern const u32 gTrainerFrontPicRedDX[];
extern const u32 gTrainerFrontPicRedClassic[];
extern const u32 gTrainerFrontPicRedAlola[];
extern const u32 gTrainerFrontPicRedSygnaSuit[];
extern const u32 gTrainerFrontPicRedTeamRocket[];
extern const u32 gTrainerFrontPicRedTeamAqua[];
extern const u32 gTrainerFrontPicRedTeamMagma[];
extern const u32 gTrainerFrontPicLeaf[];
extern const u32 gTrainerFrontPicLeafDX[];
extern const u32 gTrainerFrontPicLeafClassic[];
extern const u32 gTrainerFrontPicLeafAlola[];
extern const u32 gTrainerFrontPicLeafSygnaSuit[];
extern const u32 gTrainerFrontPicLeafTeamRocket[];
extern const u32 gTrainerFrontPicLeafTeamAqua[];
extern const u32 gTrainerFrontPicLeafTeamMagma[];
...
extern const u16 gTrainerPaletteProton[];
extern const u16 gTrainerPalettePetrel[];
extern const u16 gTrainerPaletteArcher[];
extern const u16 gTrainerPaletteAriana[];
...
extern const u16 gTrainerPalettePlayerDX[];
extern const u16 gTrainerPalettePlayerClassic[];
extern const u16 gTrainerPalettePlayerAlola[];
extern const u16 gTrainerPalettePlayerSygnaSuit[];
extern const u16 gTrainerPalettePlayerTeamRocket[];
extern const u16 gTrainerPalettePlayerTeamAqua[];
extern const u16 gTrainerPalettePlayerTeamMagma[];
...
extern const u16 gTrainerPalettePlayerOriginal[];
...
extern const u8 gTrainerBackPicRedDX[];
extern const u8 gTrainerBackPicRedClassic[];
extern const u8 gTrainerBackPicRedAlola[];
extern const u8 gTrainerBackPicRedSygnaSuit[];
extern const u8 gTrainerBackPicRedTeamRocket[];
extern const u8 gTrainerBackPicRedTeamAqua[];
extern const u8 gTrainerBackPicRedTeamMagma[];
extern const u8 gTrainerBackPicLeaf[];
extern const u8 gTrainerBackPicLeafDX[];
extern const u8 gTrainerBackPicLeafClassic[];
extern const u8 gTrainerBackPicLeafAlola[];
extern const u8 gTrainerBackPicLeafSygnaSuit[];
extern const u8 gTrainerBackPicLeafTeamRocket[];
extern const u8 gTrainerBackPicLeafTeamAqua[];
extern const u8 gTrainerBackPicLeafTeamMagma[];
...
extern const u8 gTrainerBackPicRedOriginal[];
extern const u8 gTrainerBackPicLeafOriginal[];
...
extern const u16 gTrainerBackPicPalettePlayerDX[];
extern const u16 gTrainerBackPicPalettePlayerAlola[];
extern const u16 gTrainerBackPicPalettePlayerSygnaSuit[];
extern const u16 gTrainerBackPicPalettePlayerTeamRocket[];
extern const u16 gTrainerBackPicPalettePlayerTeamAqua[];
extern const u16 gTrainerBackPicPalettePlayerTeamMagma[];
extern const u16 gTrainerBackPicPalettePokeDude[];
extern const u16 gTrainerBackPicPaletteOldMan[];
extern const u16 gTrainerBackPicPalettePlayerOriginal[];
