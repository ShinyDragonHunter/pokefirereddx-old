...
extern const u32 gMonFrontPic_VenusaurFemale[];
extern const u16 gMonPalette_Venusaur[];
extern const u32 gMonBackPic_Venusaur[];
extern const u32 gMonBackPic_VenusaurFemale[];
...
extern const u32 gMonFrontPic_ButterfreeFemale[];
extern const u16 gMonPalette_Butterfree[];
extern const u32 gMonBackPic_Butterfree[];
extern const u32 gMonBackPic_ButterfreeFemale[];
...
extern const u32 gMonFrontPic_RattataFemale[];
extern const u16 gMonPalette_Rattata[];
extern const u32 gMonBackPic_Rattata[];
extern const u32 gMonBackPic_RattataFemale[];
...
extern const u32 gMonFrontPic_RaticateFemale[];
extern const u16 gMonPalette_Raticate[];
extern const u32 gMonBackPic_Raticate[];
extern const u32 gMonBackPic_RaticateFemale[];
...
extern const u32 gMonFrontPic_PikachuFemale[];
extern const u16 gMonPalette_Pikachu[];
extern const u32 gMonBackPic_Pikachu[];
extern const u32 gMonBackPic_PikachuFemale[];
...
extern const u32 gMonFrontPic_RaichuFemale[];
...
extern const u32 gMonFrontPic_GloomFemale[];
extern const u16 gMonPalette_Gloom[];
extern const u32 gMonBackPic_Gloom[];
extern const u32 gMonBackPic_GloomFemale[];
...
extern const u32 gMonFrontPic_VileplumeFemale[];
extern const u16 gMonPalette_Vileplume[];
extern const u32 gMonBackPic_Vileplume[];
extern const u32 gMonBackPic_VileplumeFemale[];
...
extern const u32 gMonFrontPic_DoduoFemale[];
extern const u16 gMonPalette_Doduo[];
extern const u32 gMonBackPic_Doduo[];
extern const u32 gMonBackPic_DoduoFemale[];
...
extern const u32 gMonFrontPic_GyaradosFemale[];
extern const u16 gMonPalette_Gyarados[];
extern const u32 gMonBackPic_Gyarados[];
extern const u32 gMonBackPic_GyaradosFemale[];
...
extern const u32 gMonFrontPic_MeganiumFemale[];
extern const u16 gMonPalette_Meganium[];
extern const u32 gMonBackPic_Meganium[];
extern const u32 gMonBackPic_MeganiumFemale[];
...
extern const u32 gMonFrontPic_GirafarigFemale[];
...
extern const u32 gMonBackPic_TorchicFemale[];
...
extern const u32 gMonFrontPic_NuzleafFemale[];
extern const u16 gMonPalette_Nuzleaf[];
extern const u32 gMonBackPic_Nuzleaf[];
extern const u32 gMonBackPic_NuzleafFemale[];
...
extern const u32 gMonFrontPic_MedititeFemale[];
extern const u16 gMonPalette_Meditite[];
extern const u32 gMonBackPic_Meditite[];
extern const u32 gMonBackPic_MedititeFemale[];
