...
// Trainer Card
extern const u8 gText_FRLGLinkBattles[];
extern const u8 gText_LinkBattles[];
extern const u8 gText_LinkCableBattles[];
extern const u8 gText_WaitingTrainerFinishReading[];
extern const u8 gText_FRLGTrainerCardName[];
extern const u8 gText_TrainerCardName[];
extern const u8 gText_RSTrainerCardName[];
extern const u8 gText_HeliodorTrainerCardName[];
...
extern const u8 gText_FRLGHallOfFameDebut[];
extern const u8 gText_HallOfFameDebut[];
extern const u8 gText_FirstHallOfFame[];
extern const u8 gText_WinsLosses[];
extern const u8 gText_FRLGWinsLosses[];
extern const u8 gText_FRLGPokemonTrades[];
extern const u8 gText_PokemonTrades[];
extern const u8 gText_FRLGBerryCrush[];
extern const u8 gText_BerryCrush[];
extern const u8 gText_FRLGUnionTradesAndBattles[];
extern const u8 gText_UnionTradesAndBattles[];
extern const u8 gText_NumPokeblocks[];
extern const u8 gText_CDPokeblocksWithFriends[];
extern const u8 gText_PokeblocksWithFriends[];
extern const u8 gText_ContestsWFriends[];
extern const u8 gText_CDWonContestsWFriends[];
