...
// Met location strings
extern const u8 gText_LittlerootTown[];
extern const u8 gText_OldaleTown[];
extern const u8 gText_DewfordTown[];
extern const u8 gText_LavaridgeTown[];
extern const u8 gText_FallarborTown[];
extern const u8 gText_VerdanturfTown[];
extern const u8 gText_PacifidlogTown[];
extern const u8 gText_PetalburgCity[];
extern const u8 gText_MauvilleCity[];
extern const u8 gText_RustboroCity[];
extern const u8 gText_FortreeCity[];
extern const u8 gText_MossdeepCity[];
extern const u8 gText_SootopolisCity[];
extern const u8 gText_EverGrandeCity[];
extern const u8 gText_Route101[];
extern const u8 gText_Route102[];
extern const u8 gText_Route103[];
extern const u8 gText_Route104[];
extern const u8 gText_Route105[];
extern const u8 gText_Route106[];
extern const u8 gText_Route107[];
extern const u8 gText_Route108[];
extern const u8 gText_Route109[];
extern const u8 gText_Route110[];
extern const u8 gText_Route111[];
extern const u8 gText_Route112[];
extern const u8 gText_Route113[];
extern const u8 gText_Route114[];
extern const u8 gText_Route115[];
extern const u8 gText_Route116[];
extern const u8 gText_Route117[];
extern const u8 gText_Route118[];
extern const u8 gText_Route119[];
extern const u8 gText_Route120[];
extern const u8 gText_Route121[];
extern const u8 gText_Route122[];
extern const u8 gText_Route123[];
extern const u8 gText_Route124[];
extern const u8 gText_Route125[];
extern const u8 gText_Route126[];
extern const u8 gText_Route127[];
extern const u8 gText_Route128[];
extern const u8 gText_Route129[];
extern const u8 gText_Route130[];
extern const u8 gText_Route131[];
extern const u8 gText_Route132[];
extern const u8 gText_Route133[];
extern const u8 gText_Route134[];
extern const u8 gText_Underwater[];
extern const u8 gText_GraniteCave[];
extern const u8 gText_MtChimney[];
extern const u8 gText_SafariZone[];
extern const u8 gText_PetalburgWoods[];
extern const u8 gText_RusturfTunnel[];
extern const u8 gText_AbandonedShip[];
extern const u8 gText_NewMauville[];
extern const u8 gText_MeteorFalls[];
extern const u8 gText_AquaHideout[];
extern const u8 gText_MagmaHideout[];
extern const u8 gText_Hideout[];
extern const u8 gText_ShoalCave[];
extern const u8 gText_SeafloorCavern[];
extern const u8 gText_VictoryRoad[];
extern const u8 gText_MirageIsland[];
extern const u8 gText_FieryPath[];
extern const u8 gText_JaggedPass[];
extern const u8 gText_SealedChamber[];
extern const u8 gText_ScorchedSlab[];
extern const u8 gText_IslandCave[];
extern const u8 gText_DesertRuins[];
extern const u8 gText_AncientTomb[];
extern const u8 gText_InsideOfTruck[];
extern const u8 gText_SecretBase[];
extern const u8 gText_Ferry[];
extern const u8 gText_PalletTown[];
extern const u8 gText_ViridianCity[];
extern const u8 gText_PewterCity[];
extern const u8 gText_CeruleanCity[];
extern const u8 gText_LavenderTown[];
extern const u8 gText_VermilionCity[];
extern const u8 gText_CeladonCity[];
extern const u8 gText_FuchsiaCity[];
extern const u8 gText_CinnabarIsland[];
extern const u8 gText_IndigoPlateau[];
extern const u8 gText_SaffronCity[];
...
extern const u8 gText_Route15[];
extern const u8 gText_Route16[];
extern const u8 gText_Route17[];
extern const u8 gText_Route18[];
extern const u8 gText_Route19[];
extern const u8 gText_Route20[];
extern const u8 gText_Route21[];
extern const u8 gText_Route22[];
extern const u8 gText_Route23[];
extern const u8 gText_Route24[];
extern const u8 gText_Route25[];
extern const u8 gText_ViridianForest[];
extern const u8 gText_MtMoon[];
extern const u8 gText_SSAnne[];
extern const u8 gText_UndergroundPath[];
extern const u8 gText_DiglettsCave[];
extern const u8 gText_RocketHideout[];
extern const u8 gText_SilphCo[];
extern const u8 gText_PokemonMansion[];
extern const u8 gText_RockTunnel[];
extern const u8 gText_SeafoamIslands[];
extern const u8 gText_PokemonTower[];
extern const u8 gText_CeruleanCave[];
extern const u8 gText_PowerPlant[];
...
extern const u8 gText_KindleRoad[];
extern const u8 gText_TreasureBeach[];
extern const u8 gText_CapeBrink[];
extern const u8 gText_BondBridge[];
extern const u8 gText_ThreeIslePort[];
extern const u8 gText_SeviiIsle6[];
extern const u8 gText_SeviiIsle7[];
extern const u8 gText_SeviiIsle8[];
extern const u8 gText_SeviiIsle9[];
extern const u8 gText_ResortGorgeous[];
extern const u8 gText_WaterLabyrinth[];
extern const u8 gText_FiveIsleMeadow[];
extern const u8 gText_MemorialPillar[];
extern const u8 gText_OutcastIsland[];
extern const u8 gText_GreenPath[];
extern const u8 gText_WaterPath[];
extern const u8 gText_RuinValley[];
extern const u8 gText_TrainerTower[];
extern const u8 gText_CanyonEntrance[];
extern const u8 gText_SevaultCanyon[];
extern const u8 gText_TanobyRuins[];
extern const u8 gText_SeviiIsle22[];
extern const u8 gText_SeviiIsle23[];
extern const u8 gText_SeviiIsle24[];
extern const u8 gText_MtEmber[];
extern const u8 gText_BerryForest[];
extern const u8 gText_IcefallCave[];
extern const u8 gText_RocketWarehouse[];
extern const u8 gText_DottedHole[];
extern const u8 gText_LostCave[];
extern const u8 gText_PatternBush[];
extern const u8 gText_AlteringCave[];
extern const u8 gText_TanobyChambers[];
extern const u8 gText_ThreeIslePath[];
extern const u8 gText_TanobyKey[];
extern const u8 gText_MoneanChamber[];
extern const u8 gText_LiptooChamber[];
extern const u8 gText_WeepthChamber[];
extern const u8 gText_DilfordChamber[];
extern const u8 gText_ScufibChamber[];
extern const u8 gText_RixyChamber[];
extern const u8 gText_ViapoisChamber[];
extern const u8 gText_EmberSpa[];
extern const u8 gText_SpecialArea[];
extern const u8 gText_MirageTower[];
extern const u8 gText_ArtisanCave[];
extern const u8 gText_MarineCave[];
extern const u8 gText_TerraCave[];
extern const u8 gText_DesertUnderpass[];
extern const u8 gText_TrainerHill[];

// CrystalDust met location strings
extern const u8 gText_NewBarkTown[];
extern const u8 gText_CherrygroveCity[];
extern const u8 gText_AzaleaTown[];
extern const u8 gText_CianwoodCity[];
extern const u8 gText_MahoganyTown[];
extern const u8 gText_VioletCity[];
extern const u8 gText_EcruteakCity[];
extern const u8 gText_OlivineCity[];
extern const u8 gText_GoldenrodCity[];
extern const u8 gText_BlackthornCity[];
extern const u8 gText_Route29[];
extern const u8 gText_Route30[];
extern const u8 gText_Route31[];
extern const u8 gText_Route32[];
extern const u8 gText_Route33[];
extern const u8 gText_Route34[];
extern const u8 gText_Route35[];
extern const u8 gText_Route36[];
extern const u8 gText_Route37[];
extern const u8 gText_Route38[];
extern const u8 gText_Route39[];
extern const u8 gText_Route40[];
extern const u8 gText_Route41[];
extern const u8 gText_Route42[];
extern const u8 gText_Route43[];
extern const u8 gText_Route44[];
extern const u8 gText_Route45[];
extern const u8 gText_Route46[];
extern const u8 gText_Route26[];
extern const u8 gText_Route27[];
extern const u8 gText_Route28[];
extern const u8 gText_DarkCave[];
extern const u8 gText_SlowpokeWell_B1F[];
extern const u8 gText_IlexForest[];
extern const u8 gText_UnionCave[];
extern const u8 gText_SproutTower[];
extern const u8 gText_RuinsOfAlph[];
extern const u8 gText_AlphChambers[];
extern const u8 gText_RadioTower[];
extern const u8 gText_MtMortar[];
extern const u8 gText_Lighthouse[];
extern const u8 gText_DragonsDen[];
extern const u8 gText_LakeOfRage[];
extern const u8 gText_NationalPark[];
extern const u8 gText_IcePath[];
extern const u8 gText_SilverCave[];
extern const u8 gText_WhirlIslands[];
extern const u8 gText_TinTower[];
