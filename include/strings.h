...
extern const u8 gMenuText_SelectButton[];
extern const u8 gMenuText_LButton[];
extern const u8 gMenuText_RButton[];
...
extern const u8 gText_PlayedPokeFluteCatchyTune[];
extern const u8 gText_PlayedPokeFlute[];
extern const u8 gText_PokeFluteAwakened[];
