...
#define SCROLL_MULTI_BF_EXCHANGE_CORNER_VITAMIN_VENDOR     3
#define SCROLL_MULTI_BF_EXCHANGE_CORNER_HOLD_ITEM_VENDOR   4
#define SCROLL_MULTI_BERRY_POWDER_VENDOR                   5
#define SCROLL_MULTI_BF_RECEPTIONIST                       6
#define SCROLL_MULTI_BF_MOVE_TUTOR_1                       7
#define SCROLL_MULTI_BF_MOVE_TUTOR_2                       8
