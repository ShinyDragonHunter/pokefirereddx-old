...
#define SPECIES_DEOXYS_SPEED (NUM_SPECIES + 28)
#define SPECIES_DEOXYS_ATTACK (NUM_SPECIES + 29)
#define SPECIES_DEOXYS_DEFENSE (NUM_SPECIES + 30)

#define SPECIES_COUNT (NUM_SPECIES + 31)
