...
#define NATIONAL_DEX_RATTATA_ALOLAN (NATIONAL_DEX_OLD_UNOWN_B + 25)
#define NATIONAL_DEX_RATICATE_ALOLAN (NATIONAL_DEX_OLD_UNOWN_B + 26)
#define NATIONAL_DEX_RAICHU_ALOLAN (NATIONAL_DEX_OLD_UNOWN_B + 27)
#define NATIONAL_DEX_SANDSHREW_ALOLAN (NATIONAL_DEX_OLD_UNOWN_B + 28)
#define NATIONAL_DEX_SANDSLASH_ALOLAN (NATIONAL_DEX_OLD_UNOWN_B + 29)
#define NATIONAL_DEX_VULPIX_ALOLAN (NATIONAL_DEX_OLD_UNOWN_B + 30)
#define NATIONAL_DEX_NINETALES_ALOLAN (NATIONAL_DEX_OLD_UNOWN_B + 31)
#define NATIONAL_DEX_DIGLETT_ALOLAN (NATIONAL_DEX_OLD_UNOWN_B + 32)
#define NATIONAL_DEX_DUGTRIO_ALOLAN (NATIONAL_DEX_OLD_UNOWN_B + 33)
#define NATIONAL_DEX_MEOWTH_ALOLAN (NATIONAL_DEX_OLD_UNOWN_B + 34)
#define NATIONAL_DEX_PERSIAN_ALOLAN (NATIONAL_DEX_OLD_UNOWN_B + 35)
#define NATIONAL_DEX_GEODUDE_ALOLAN (NATIONAL_DEX_OLD_UNOWN_B + 36)
#define NATIONAL_DEX_GRAVELER_ALOLAN (NATIONAL_DEX_OLD_UNOWN_B + 37)
#define NATIONAL_DEX_GOLEM_ALOLAN (NATIONAL_DEX_OLD_UNOWN_B + 38)
#define NATIONAL_DEX_PONYTA_GALARIAN (NATIONAL_DEX_OLD_UNOWN_B + 39)
#define NATIONAL_DEX_RAPIDASH_GALARIAN (NATIONAL_DEX_OLD_UNOWN_B + 40)
#define NATIONAL_DEX_SLOWPOKE_GALARIAN (NATIONAL_DEX_OLD_UNOWN_B + 41)
#define NATIONAL_DEX_SLOWBRO_GALARIAN (NATIONAL_DEX_OLD_UNOWN_B + 42)
#define NATIONAL_DEX_FARFETCHD_GALARIAN (NATIONAL_DEX_OLD_UNOWN_B + 43)
#define NATIONAL_DEX_GRIMER_ALOLAN (NATIONAL_DEX_OLD_UNOWN_B + 44)
#define NATIONAL_DEX_MUK_ALOLAN (NATIONAL_DEX_OLD_UNOWN_B + 45)
#define NATIONAL_DEX_EXEGGUTOR_ALOLAN (NATIONAL_DEX_OLD_UNOWN_B + 46)
#define NATIONAL_DEX_MAROWAK_ALOLAN (NATIONAL_DEX_OLD_UNOWN_B + 47)
#define NATIONAL_DEX_WEEZING_GALARIAN (NATIONAL_DEX_OLD_UNOWN_B + 48)
#define NATIONAL_DEX_MR_MIME_GALARIAN (NATIONAL_DEX_OLD_UNOWN_B + 49)
#define NATIONAL_DEX_ARTICUNO_GALARIAN (NATIONAL_DEX_OLD_UNOWN_B + 50)
#define NATIONAL_DEX_ZAPDOS_GALARIAN (NATIONAL_DEX_OLD_UNOWN_B + 51)
#define NATIONAL_DEX_MOLTRES_GALARIAN (NATIONAL_DEX_OLD_UNOWN_B + 52)
#define NATIONAL_DEX_MEWTWO_ARMORED (NATIONAL_DEX_OLD_UNOWN_B + 53)
#define NATIONAL_DEX_SLOWKING_GALARIAN (NATIONAL_DEX_OLD_UNOWN_B + 54)
#define NATIONAL_DEX_CORSOLA_GALARIAN (NATIONAL_DEX_OLD_UNOWN_B + 55)
#define NATIONAL_DEX_LUGIA_SHADOW (NATIONAL_DEX_OLD_UNOWN_B + 56)
#define NATIONAL_DEX_ZIGZAGOON_GALARIAN (NATIONAL_DEX_OLD_UNOWN_B + 57)
#define NATIONAL_DEX_LINOONE_GALARIAN (NATIONAL_DEX_OLD_UNOWN_B + 58)

#define NATIONAL_DEX_DEOXYS_SPEED (NATIONAL_DEX_OLD_UNOWN_B + 59)
#define NATIONAL_DEX_DEOXYS_ATTACK (NATIONAL_DEX_OLD_UNOWN_B + 60)
#define NATIONAL_DEX_DEOXYS_DEFENSE (NATIONAL_DEX_OLD_UNOWN_B + 61)
...
#define HOENN_DEX_RATTATA_ALOLAN (HOENN_DEX_OLD_UNOWN_B + 25)
#define HOENN_DEX_RATICATE_ALOLAN (HOENN_DEX_OLD_UNOWN_B + 26)
#define HOENN_DEX_RAICHU_ALOLAN (HOENN_DEX_OLD_UNOWN_B + 27)
#define HOENN_DEX_SANDSHREW_ALOLAN (HOENN_DEX_OLD_UNOWN_B + 28)
#define HOENN_DEX_SANDSLASH_ALOLAN (HOENN_DEX_OLD_UNOWN_B + 29)
#define HOENN_DEX_VULPIX_ALOLAN (HOENN_DEX_OLD_UNOWN_B + 30)
#define HOENN_DEX_NINETALES_ALOLAN (HOENN_DEX_OLD_UNOWN_B + 31)
#define HOENN_DEX_DIGLETT_ALOLAN (HOENN_DEX_OLD_UNOWN_B + 32)
#define HOENN_DEX_DUGTRIO_ALOLAN (HOENN_DEX_OLD_UNOWN_B + 33)
#define HOENN_DEX_MEOWTH_ALOLAN (HOENN_DEX_OLD_UNOWN_B + 34)
#define HOENN_DEX_PERSIAN_ALOLAN (HOENN_DEX_OLD_UNOWN_B + 35)
#define HOENN_DEX_GEODUDE_ALOLAN (HOENN_DEX_OLD_UNOWN_B + 36)
#define HOENN_DEX_GRAVELER_ALOLAN (HOENN_DEX_OLD_UNOWN_B + 37)
#define HOENN_DEX_GOLEM_ALOLAN (HOENN_DEX_OLD_UNOWN_B + 38)
#define HOENN_DEX_PONYTA_GALARIAN (HOENN_DEX_OLD_UNOWN_B + 39)
#define HOENN_DEX_RAPIDASH_GALARIAN (HOENN_DEX_OLD_UNOWN_B + 40)
#define HOENN_DEX_SLOWPOKE_GALARIAN (HOENN_DEX_OLD_UNOWN_B + 41)
#define HOENN_DEX_SLOWBRO_GALARIAN (HOENN_DEX_OLD_UNOWN_B + 42)
#define HOENN_DEX_FARFETCHD_GALARIAN (HOENN_DEX_OLD_UNOWN_B + 43)
#define HOENN_DEX_GRIMER_ALOLAN (HOENN_DEX_OLD_UNOWN_B + 44)
#define HOENN_DEX_MUK_ALOLAN (HOENN_DEX_OLD_UNOWN_B + 45)
#define HOENN_DEX_EXEGGUTOR_ALOLAN (HOENN_DEX_OLD_UNOWN_B + 46)
#define HOENN_DEX_MAROWAK_ALOLAN (HOENN_DEX_OLD_UNOWN_B + 47)
#define HOENN_DEX_WEEZING_GALARIAN (HOENN_DEX_OLD_UNOWN_B + 48)
#define HOENN_DEX_MR_MIME_GALARIAN (HOENN_DEX_OLD_UNOWN_B + 49)
#define HOENN_DEX_ARTICUNO_GALARIAN (HOENN_DEX_OLD_UNOWN_B + 50)
#define HOENN_DEX_ZAPDOS_GALARIAN (HOENN_DEX_OLD_UNOWN_B + 51)
#define HOENN_DEX_MOLTRES_GALARIAN (HOENN_DEX_OLD_UNOWN_B + 52)
#define HOENN_DEX_MEWTWO_ARMORED (HOENN_DEX_OLD_UNOWN_B + 53)
#define HOENN_DEX_SLOWKING_GALARIAN (HOENN_DEX_OLD_UNOWN_B + 54)
#define HOENN_DEX_CORSOLA_GALARIAN (HOENN_DEX_OLD_UNOWN_B + 55)
#define HOENN_DEX_LUGIA_SHADOW (HOENN_DEX_OLD_UNOWN_B + 56)
#define HOENN_DEX_ZIGZAGOON_GALARIAN (HOENN_DEX_OLD_UNOWN_B + 57)
#define HOENN_DEX_LINOONE_GALARIAN (HOENN_DEX_OLD_UNOWN_B + 58)

#define HOENN_DEX_DEOXYS_SPEED (HOENN_DEX_OLD_UNOWN_B + 59)
#define HOENN_DEX_DEOXYS_ATTACK (HOENN_DEX_OLD_UNOWN_B + 60)
#define HOENN_DEX_DEOXYS_DEFENSE (HOENN_DEX_OLD_UNOWN_B + 61)
