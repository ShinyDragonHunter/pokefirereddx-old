...
#define FORM_SPECIES_START (NUM_SPECIES + 28)

#define SPECIES_DEOXYS_SPEED FORM_SPECIES_START
#define SPECIES_DEOXYS_ATTACK (FORM_SPECIES_START + 1)
#define SPECIES_DEOXYS_DEFENSE (FORM_SPECIES_START + 2)

#define SPECIES_COUNT (FORM_SPECIES_START + 3)
...
#define NATIONAL_DEX_DEOXYS_SPEED   (NATIONAL_DEX_OLD_UNOWN_B + 25)
#define NATIONAL_DEX_DEOXYS_ATTACK  (NATIONAL_DEX_OLD_UNOWN_B + 26)
#define NATIONAL_DEX_DEOXYS_DEFENSE (NATIONAL_DEX_OLD_UNOWN_B + 27)
...
#define HOENN_DEX_DEOXYS_SPEED  (HOENN_DEX_OLD_UNOWN_B + 25)
#define HOENN_DEX_DEOXYS_ATTACK (HOENN_DEX_OLD_UNOWN_B + 26)
#define HOENN_DEX_DEOXYS_DEFENSE (HOENN_DEX_OLD_UNOWN_B + 27)
