...
#define SPECIES_ARBOK_KANTO (SPECIES_UNOWN_B + 27)

// Any species from here are only used for a Pokémon's form
#define FORM_SPECIES SPECIES_ARBOK_KANTO

#define SPECIES_RATTATA_ALOLAN (FORM_SPECIES + 1)
#define SPECIES_RATICATE_ALOLAN (FORM_SPECIES + 2)
#define SPECIES_RAICHU_ALOLAN (FORM_SPECIES + 3)
#define SPECIES_SANDSHREW_ALOLAN (FORM_SPECIES + 4)
#define SPECIES_SANDSLASH_ALOLAN (FORM_SPECIES + 5)
#define SPECIES_VULPIX_ALOLAN (FORM_SPECIES+ 6)
#define SPECIES_NINETALES_ALOLAN (FORM_SPECIES + 7)
#define SPECIES_DIGLETT_ALOLAN (FORM_SPECIES + 8)
#define SPECIES_DUGTRIO_ALOLAN (FORM_SPECIES + 9)
#define SPECIES_MEOWTH_ALOLAN (FORM_SPECIES + 10)
#define SPECIES_PERSIAN_ALOLAN (FORM_SPECIES + 11)
#define SPECIES_GEODUDE_ALOLAN (FORM_SPECIES + 12)
#define SPECIES_GRAVELER_ALOLAN (FORM_SPECIES + 13)
#define SPECIES_GOLEM_ALOLAN (FORM_SPECIES + 14)
#define SPECIES_PONYTA_GALARIAN (FORM_SPECIES + 15)
#define SPECIES_RAPIDASH_GALARIAN (FORM_SPECIES + 16)
#define SPECIES_SLOWPOKE_GALARIAN (FORM_SPECIES + 17)
#define SPECIES_SLOWBRO_GALARIAN (FORM_SPECIES + 18)
#define SPECIES_GRIMER_ALOLAN (FORM_SPECIES + 19)
#define SPECIES_MUK_ALOLAN (FORM_SPECIES + 20)
#define SPECIES_EXEGGUTOR_ALOLAN (FORM_SPECIES + 21)
#define SPECIES_MAROWAK_ALOLAN (FORM_SPECIES + 22)
#define SPECIES_WEEZING_GALARIAN (FORM_SPECIES + 23)
#define SPECIES_ARTICUNO_GALARIAN (FORM_SPECIES + 24)
#define SPECIES_ZAPDOS_GALARIAN (FORM_SPECIES + 25)
#define SPECIES_MOLTRES_GALARIAN (FORM_SPECIES + 26)
#define SPECIES_MEWTWO_ARMORED (FORM_SPECIES + 27)
#define SPECIES_SLOWKING_GALARIAN (FORM_SPECIES + 28)
#define SPECIES_LUGIA_SHADOW (FORM_SPECIES + 29)
#define SPECIES_DEOXYS_SPEED (FORM_SPECIES + 30)
#define SPECIES_DEOXYS_ATTACK (FORM_SPECIES + 31)
#define SPECIES_DEOXYS_DEFENSE (FORM_SPECIES + 32)

#define NUM_FORM_SPECIES (SPECIES_DEOXYS_DEFENSE + 1 - FORM_SPECIES)
#define SPECIES_COUNT (FORM_SPECIES + NUM_FORM_SPECIES)
...
// species flags
#define FLAG_GENDER_DIFFERENCE  (1 << 0)
#define FLAG_LEGENDARY  (1 << 1)
#define FLAG_SPECIAL  (1 << 2) // Battle facility ban
#define FLAG_OBEDIENCE_CHECK  (1 << 3) // Mew and Deoxys disobedience check
