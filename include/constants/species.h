...
#define SPECIES_DEOXYS_SPEED (SPECIES_UNOWN_B + 27)
#define SPECIES_DEOXYS_ATTACK (SPECIES_UNOWN_B + 28)
#define SPECIES_DEOXYS_DEFENSE (SPECIES_UNOWN_B + 29)

#define SPECIES_COUNT (SPECIES_UNOWN_B + 30)
