...
#define BATTLE_TYPE_TWO_OPPONENTS      (1 << 12)
#define BATTLE_TYPE_DOME               (1 << 13)
#define BATTLE_TYPE_PALACE             (1 << 14)
#define BATTLE_TYPE_ARENA              (1 << 15)
#define BATTLE_TYPE_FACTORY            (1 << 16)
#define BATTLE_TYPE_PIKE               (1 << 17)
#define BATTLE_TYPE_PYRAMID            (1 << 18)
#define BATTLE_TYPE_INGAME_PARTNER     (1 << 19)
#define BATTLE_TYPE_TOWER_LINK_MULTI   (1 << 20)
#define BATTLE_TYPE_RECORDED           (1 << 21)
#define BATTLE_TYPE_RECORDED_LINK      (1 << 22)
#define BATTLE_TYPE_TRAINER_HILL       (1 << 23)
#define BATTLE_TYPE_SECRET_BASE        (1 << 24)
#define BATTLE_TYPE_RECORDED_IS_MASTER (1 << 25)
...
#define BATTLE_TERRAIN_INDOOR_1    12
#define BATTLE_TERRAIN_INDOOR_2    13
#define BATTLE_TERRAIN_LORELEI     14
#define BATTLE_TERRAIN_BRUNO       15
#define BATTLE_TERRAIN_AGATHA      16
#define BATTLE_TERRAIN_LANCE       17
