...
#define BATTLE_TYPE_ARENA              (1 << 17)
#define BATTLE_TYPE_FACTORY            (1 << 18)
#define BATTLE_TYPE_PIKE               (1 << 19)
#define BATTLE_TYPE_PYRAMID            (1 << 20)
#define BATTLE_TYPE_INGAME_PARTNER     (1 << 21)
#define BATTLE_TYPE_TOWER_LINK_MULTI   (1 << 22)
#define BATTLE_TYPE_RECORDED           (1 << 23)
#define BATTLE_TYPE_RECORDED_LINK      (1 << 24)
#define BATTLE_TYPE_TRAINER_HILL       (1 << 25)
#define BATTLE_TYPE_RECORDED_IS_MASTER (1 << 26)
