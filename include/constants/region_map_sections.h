...
#define MAPSEC_AZALEA_TOWN                      0xD7
#define MAPSEC_CIANWOOD_CITY                    0xD8
#define MAPSEC_MAHOGANY_TOWN                    0xD9
#define MAPSEC_VIOLET_CITY                      0xDA
#define MAPSEC_ECRUTEAK_CITY                    0xDB
#define MAPSEC_OLIVINE_CITY                     0xDC
#define MAPSEC_GOLDENROD_CITY                   0xDD
...
#define MAPSEC_SPROUT_TOWER                     0xF4
#define MAPSEC_RUINS_OF_ALPH                    0xF5
#define MAPSEC_UNION_CAVE                       0xF6
#define MAPSEC_SLOWPOKE_WELL                    0xF7
#define MAPSEC_ILEX_FOREST                      0xF8
...
#define MAPSEC_WHIRL_ISLANDS                    0x100
#define MAPSEC_LAKE_OF_RAGE                     0x101
#define MAPSEC_ROCKET_HQ                        0x102
#define MAPSEC_RADIO_TOWER                      0x103
#define MAPSEC_MT_MORTAR                        0x104
#define MAPSEC_LIGHTHOUSE                       0x105
#define MAPSEC_ICE_PATH                         0x106
#define MAPSEC_DRAGONS_DEN                      0x107
#define MAPSEC_DARK_CAVE                        0x108
#define MAPSEC_SILVER_CAVE                      0x109
#define MAPSEC_TOHJO_FALLS                      0x10A
#define MAPSEC_FAST_SHIP                        0x10B

#define MAPSEC_OUTSKIRT_STAND                   0x10C
#define MAPSEC_CIPHER_LAB                       0x10D
#define MAPSEC_PHENAC_CITY                      0x10E
#define MAPSEC_MAYORS_HOUSE                     0x10F
#define MAPSEC_PRE_GYM                          0x110
#define MAPSEC_MT_BATTLE                        0x111
#define MAPSEC_PHENAC_STADIUM                   0x112
#define MAPSEC_PYRITE_TOWN                      0x113
#define MAPSEC_PYRITE_BUILDING                  0x114
#define MAPSEC_PYRITE_CAVE                      0x115
#define MAPSEC_MIRORS_HIDEOUT                   0x116
#define MAPSEC_PYRITE_COLOSSEUM                 0x117
#define MAPSEC_AGATE_VILLAGE                    0x118
#define MAPSEC_SS_LIBRA                         0x119
#define MAPSEC_RELIC_CAVE                       0x11A
#define MAPSEC_THE_UNDER                        0x11B
#define MAPSEC_REALGAM_TOWER                    0x11C
#define MAPSEC_THE_UNDER_SUBWAY                 0x11D
#define MAPSEC_UNDER_COLOSSEUM                  0x11E
#define MAPSEC_DEEP_COLOSSEUM                   0x11F
#define MAPSEC_CIPHER_KEY_LAIR                  0x120
#define MAPSEC_FRONT_OF_LAB                     0x121
#define MAPSEC_LABORATORY                       0x122
#define MAPSEC_CITADARK_ISLE                    0x123
#define MAPSEC_POKE_SPOT_ROCK                   0x124
#define MAPSEC_POKE_SPOT_OASIS                  0x125
#define MAPSEC_POKE_SPOT_CAVE                   0x126
#define MAPSEC_MT_BATTLE_COLOSSEUM              0x127
#define MAPSEC_REALGAM_TOWER_DOME               0x128
#define MAPSEC_REALGAM_TOWER_LOBBY              0x129
#define MAPSEC_TOWER_COLOSSEUM                  0x12A
#define MAPSEC_ORRE_COLOSSEUM                   0x12B
#define MAPSEC_SNAGEM_HIDEOUT                   0x12C
#define MAPSEC_POKEMON_HQ_LAB                   0x12D
#define MAPSEC_GATEON_PORT                      0x12E
#define MAPSEC_KAMINKOS_HOUSE                   0x12F
