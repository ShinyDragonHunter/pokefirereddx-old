...
#define PARTY_ACTION_GIVE_MAILBOX_MAIL  6
#define PARTY_ACTION_SWITCH             7
#define PARTY_ACTION_SWITCHING          8
#define PARTY_ACTION_SOFTBOILED         9
...
#define PARTYBOX_DESC_LEARNED     7
#define PARTYBOX_DESC_HAVE        8
#define PARTYBOX_DESC_DONT_HAVE   9
