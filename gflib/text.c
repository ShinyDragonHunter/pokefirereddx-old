...
extern const u8 gFont6LatinGlyphWidths[];
...
u16 RenderText(struct TextPrinter *textPrinter)
{
    ...
    case 0:
        ...
        case 1:
            ...
            break;
        default:
            DecompressGlyphFont2(subStruct->glyphId, currChar, textPrinter->japanese);
            break;
        case 3:
...
u8 RenderTextFont4(u8 *pixels, u8 *str)
{
    u8 shadowColor;
    u8 *strLocal;
    int strPos, temp, temp2;
    u8 colorBackup[3], fgColor, bgColor, fontId;
    ...
    do
    {
        ...
        case EOS:
            break;
        default:
            DecompressGlyphFont4(temp, TRUE);
...
void DecompressGlyphFont2(u8 fontId, u16 glyphId, bool32 isJapanese)
{
    ...
    else
    {
        ...
        if (fontId == 2)
            ...
            gCurGlyph.width = gFont6LatinGlyphWidths[glyphId];
...
void DecompressGlyphFont4(u16 glyphId, bool32 isJapanese)
{
    ...
    if (isJapanese)
    {
        glyphs = gFont4JapaneseGlyphs + (0x100 * (glyphId >> 0x4)) + (0x8 * (glyphId & 0xF));
        DecompressGlyphTile(glyphs, gCurGlyph.gfxBufferTop);
        DecompressGlyphTile(glyphs + 0x80, gCurGlyph.gfxBufferBottom);
        gCurGlyph.width = 8;
        gCurGlyph.height = 12;
...
void DecompressGlyphFont5(u16 glyphId, bool32 isJapanese)
{
    ...
    else
    {
        ...
        gCurGlyph.width = gFont5LatinGlyphWidths[glyphId];
...
u32 GetGlyphWidthFont6(u16 glyphId, bool32 isJapanese)
{
    if (isJapanese)
        return gFont2JapaneseGlyphWidths[glyphId];
    return gFont6LatinGlyphWidths[glyphId];
}
