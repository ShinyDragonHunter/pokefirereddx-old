...
static void TextSpeed_DrawChoices(u8 selection)
{
    ...
    widthSlow = GetStringWidth(2, gText_TextSpeedSlow, 0);
    widthMid = GetStringWidth(2, gText_TextSpeedMid, 0);
    widthFast = GetStringWidth(2, gText_TextSpeedFast, 0);

    widthMid -= 94;
    xMid = (widthSlow - widthMid - widthFast) / 2 + 104;
    DrawOptionMenuChoice(gText_TextSpeedMid, xMid, YPOS_TEXTSPEED, styles[1]);

    DrawOptionMenuChoice(gText_TextSpeedFast, GetStringRightAlignXOffset(2, gText_TextSpeedFast, 198), YPOS_TEXTSPEED, styles[2]);
}
...
static void BattleScene_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_BattleSceneOff, GetStringRightAlignXOffset(2, gText_BattleSceneOff, 198), YPOS_BATTLESCENE, styles[1]);
}
...
static void BattleStyle_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_BattleStyleSet, GetStringRightAlignXOffset(2, gText_BattleStyleSet, 198), YPOS_BATTLESTYLE, styles[1]);
}
...
static void Sound_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_SoundStereo, GetStringRightAlignXOffset(2, gText_SoundStereo, 198), YPOS_SOUND, styles[1]);
}
...
static void ButtonMode_DrawChoices(u8 selection)
{
    ...
    widthNormal = GetStringWidth(2, gText_ButtonTypeNormal, 0);
    widthLR = GetStringWidth(2, gText_ButtonTypeLR, 0);
    widthLA = GetStringWidth(2, gText_ButtonTypeLEqualsA, 0);

    widthLR -= 94;
    xLR = (widthNormal - widthLR - widthLA) / 2 + 104;
    DrawOptionMenuChoice(gText_ButtonTypeLR, xLR, YPOS_BUTTONMODE, styles[1]);

    DrawOptionMenuChoice(gText_ButtonTypeLEqualsA, GetStringRightAlignXOffset(2, gText_ButtonTypeLEqualsA, 198), YPOS_BUTTONMODE, styles[2]);
}

static void DrawTextOption(void)
{
    FillWindowPixelBuffer(WIN_TEXT_OPTION, PIXEL_FILL(1));
    AddTextPrinterParameterized(WIN_TEXT_OPTION, 2, gText_MainMenuOption, 8, 1, TEXT_SPEED_FF, NULL);
...
static void DrawOptionMenuTexts(void)
{
    ...
    {
        AddTextPrinterParameterized(WIN_OPTIONS, 2, sOptionMenuItemsNames[i], 8, (i * 16) + 1, TEXT_SPEED_FF, NULL);
    }
    CopyWindowToVram(WIN_OPTIONS, 3);
}
