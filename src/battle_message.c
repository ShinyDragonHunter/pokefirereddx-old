...
static const u8 sText_PkmnRaisedSpDef[] = _("{B_ATK_PREFIX}'s {B_CURRENT_MOVE}\nraised SP. DEF!");
static const u8 sText_PkmnRaisedSpDefALittle[] = _("{B_ATK_PREFIX}'s {B_CURRENT_MOVE}\nraised SP. DEF a little!");
#if UK
static const u8 sText_PkmnRaisedDef[] = _("{B_ATK_PREFIX}'s {B_CURRENT_MOVE}\nraised DEFENCE!");
static const u8 sText_PkmnRaisedDefALittle[] = _("{B_ATK_PREFIX}'s {B_CURRENT_MOVE}\nraised DEFENCE a little!");
#else
static const u8 sText_PkmnRaisedDef[] = _("{B_ATK_PREFIX}'s {B_CURRENT_MOVE}\nraised DEFENSE!");
static const u8 sText_PkmnRaisedDefALittle[] = _("{B_ATK_PREFIX}'s {B_CURRENT_MOVE}\nraised DEFENSE a little!");
#endif
static const u8 sText_PkmnCoveredByVeil[] = _("{B_ATK_PREFIX}'s party is covered\nby a veil!");
static const u8 sText_PkmnUsedSafeguard[] = _("{B_DEF_NAME_WITH_PREFIX}'s party is protected\nby SAFEGUARD!");
static const u8 sText_PkmnSafeguardExpired[] = _("{B_ATK_PREFIX}'s party is no longer\nprotected by SAFEGUARD!");
...
const u8 gText_PkmnShroudedInMist[] = _("{B_ATK_PREFIX} became\nshrouded in MIST!");
...
static const u8 sText_PkmnsXWoreOff[] = _("{B_ATK_PREFIX}'s {B_BUFF1}\nwore off!");
...
static const u8 * const sPokeblockWasTooXStringTable[FLAVOR_COUNT] =
{
...
const u8 * const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_DUMMY288 - 12] = gText_ExpandedPlaceholder_Empty,
    [STRINGID_DUMMY289 - 12] = gText_ExpandedPlaceholder_Empty,
    ...
    [STRINGID_EMPTYSTRING3 - 12] = gText_ExpandedPlaceholder_Empty,
    ...
    [STRINGID_EMPTYSTRING4 - 12] = gText_ExpandedPlaceholder_Empty,
...
static const u8 gText_BattleRivalName[] = _("{RIVAL}");
    ...
    *(&gBattleStruct->stringMoveType) = gBattleMsgDataPtr->moveType;
    ...
    case STRINGID_USEDMOVE: // pokemon used a move msg
        if (gBattleMsgDataPtr->currentMove >= MOVES_COUNT)
            StringCopy(gBattleTextBuff1, sATypeMove_Table[*(&gBattleStruct->stringMoveType)]);
        else
            StringCopy(gBattleTextBuff1, gMoveNames[gBattleMsgDataPtr->currentMove]);
    ...
    while (*src != EOS)
    {
        if (*src == PLACEHOLDER_BEGIN)
        {
            ...
            case B_TXT_PLAYER_MON1_NAME: // first player poke name
                GetMonData(&gPlayerParty[gBattlerPartyIndexes[GetBattlerAtPosition(B_POSITION_PLAYER_LEFT)]], MON_DATA_NICKNAME, text);
                StringGetEnd10(text);
                toCpy = text;
                break;
            case B_TXT_OPPONENT_MON1_NAME: // first enemy poke name
                GetMonData(&gEnemyParty[gBattlerPartyIndexes[GetBattlerAtPosition(B_POSITION_OPPONENT_LEFT)]], MON_DATA_NICKNAME, text);
                StringGetEnd10(text);
                toCpy = text;
                break;
            case B_TXT_PLAYER_MON2_NAME: // second player poke name
                GetMonData(&gPlayerParty[gBattlerPartyIndexes[GetBattlerAtPosition(B_POSITION_PLAYER_RIGHT)]], MON_DATA_NICKNAME, text);
                StringGetEnd10(text);
                toCpy = text;
                break;
            case B_TXT_OPPONENT_MON2_NAME: // second enemy poke name
                GetMonData(&gEnemyParty[gBattlerPartyIndexes[GetBattlerAtPosition(B_POSITION_OPPONENT_RIGHT)]], MON_DATA_NICKNAME, text);
                StringGetEnd10(text);
                toCpy = text;
                break;
            ...
            case B_TXT_ATK_NAME_WITH_PREFIX_MON1: // attacker name with prefix, only battlerId 0/1
                HANDLE_NICKNAME_STRING_CASE(gBattlerAttacker, gBattlerPartyIndexes[GetBattlerAtPosition(GET_BATTLER_SIDE(gBattlerAttacker))])
                break;
