...
// Region map section strings
const u8 gText_LittlerootTown[] = _("LITTLEROOT TOWN");
const u8 gText_OldaleTown[] = _("OLDALE TOWN");
const u8 gText_DewfordTown[] = _("DEWFORD TOWN");
const u8 gText_LavaridgeTown[] = _("LAVARIDGE TOWN");
const u8 gText_FallarborTown[] = _("FALLARBOR TOWN");
const u8 gText_VerdanturfTown[] = _("VERDANTURF TOWN");
const u8 gText_PacifidlogTown[] = _("PACIFIDLOG TOWN");
const u8 gText_PetalburgCity[] = _("PETALBURG CITY");
const u8 gText_MauvilleCity[] = _("MAUVILLE CITY");
const u8 gText_RustboroCity[] = _("RUSTBORO CITY");
const u8 gText_FortreeCity[] = _("FORTREE CITY");
const u8 gText_MossdeepCity[] = _("MOSSDEEP CITY");
const u8 gText_SootopolisCity[] = _("SOOTOPOLIS CITY");
const u8 gText_EverGrandeCity[] = _("EVER GRANDE CITY");
const u8 gText_Route101[] = _("ROUTE 101");
const u8 gText_Route102[] = _("ROUTE 102");
const u8 gText_Route103[] = _("ROUTE 103");
const u8 gText_Route104[] = _("ROUTE 104");
const u8 gText_Route105[] = _("ROUTE 105");
const u8 gText_Route106[] = _("ROUTE 106");
const u8 gText_Route107[] = _("ROUTE 107");
const u8 gText_Route108[] = _("ROUTE 108");
const u8 gText_Route109[] = _("ROUTE 109");
const u8 gText_Route110[] = _("ROUTE 110");
const u8 gText_Route111[] = _("ROUTE 111");
const u8 gText_Route112[] = _("ROUTE 112");
const u8 gText_Route113[] = _("ROUTE 113");
const u8 gText_Route114[] = _("ROUTE 114");
const u8 gText_Route115[] = _("ROUTE 115");
const u8 gText_Route116[] = _("ROUTE 116");
const u8 gText_Route117[] = _("ROUTE 117");
const u8 gText_Route118[] = _("ROUTE 118");
const u8 gText_Route119[] = _("ROUTE 119");
const u8 gText_Route120[] = _("ROUTE 120");
const u8 gText_Route121[] = _("ROUTE 121");
const u8 gText_Route122[] = _("ROUTE 122");
const u8 gText_Route123[] = _("ROUTE 123");
const u8 gText_Route124[] = _("ROUTE 124");
const u8 gText_Route125[] = _("ROUTE 125");
const u8 gText_Route126[] = _("ROUTE 126");
const u8 gText_Route127[] = _("ROUTE 127");
const u8 gText_Route128[] = _("ROUTE 128");
const u8 gText_Route129[] = _("ROUTE 129");
const u8 gText_Route130[] = _("ROUTE 130");
const u8 gText_Route131[] = _("ROUTE 131");
const u8 gText_Route132[] = _("ROUTE 132");
const u8 gText_Route133[] = _("ROUTE 133");
const u8 gText_Route134[] = _("ROUTE 134");
const u8 gText_Underwater[] = _("UNDERWATER");
const u8 gText_GraniteCave[] = _("GRANITE CAVE");
const u8 gText_MtChimney[] = _("MT. CHIMNEY");
const u8 gText_SafariZone[] = _("SAFARI ZONE");
const u8 gText_PetalburgWoods[] = _("PETALBURG WOODS");
const u8 gText_RusturfTunnel[] = _("RUSTURF TUNNEL");
const u8 gText_AbandonedShip[] = _("ABANDONED SHIP");
const u8 gText_NewMauville[] = _("NEW MAUVILLE");
const u8 gText_MeteorFalls[] = _("METEOR FALLS");
const u8 gText_AquaHideout[] = _("AQUA HIDEOUT");
const u8 gText_MagmaHideout[] = _("MAGMA HIDEOUT");
const u8 gText_Hideout[] = _("HIDEOUT");
const u8 gText_ShoalCave[] = _("SHOAL CAVE");
const u8 gText_SeafloorCavern[] = _("SEAFLOOR CAVERN");
const u8 gText_VictoryRoad[] = _("VICTORY ROAD");
const u8 gText_MirageIsland[] = _("MIRAGE ISLAND");
const u8 gText_FieryPath[] = _("FIERY PATH");
const u8 gText_JaggedPass[] = _("JAGGED PASS");
const u8 gText_SealedChamber[] = _("SEALED CHAMBER");
const u8 gText_ScorchedSlab[] = _("SCORCHED SLAB");
const u8 gText_IslandCave[] = _("ISLAND CAVE");
const u8 gText_DesertRuins[] = _("DESERT RUINS");
const u8 gText_AncientTomb[] = _("ANCIENT TOMB");
const u8 gText_InsideOfTruck[] = _("INSIDE OF TRUCK");
const u8 gText_SecretBase[] = _("SECRET BASE");
const u8 gText_Ferry[] = _("FERRY");
const u8 gText_PalletTown[] = _("PALLET TOWN");
const u8 gText_ViridianCity[] = _("VIRIDIAN CITY");
const u8 gText_PewterCity[] = _("PEWTER CITY");
const u8 gText_CeruleanCity[] = _("CERULEAN CITY");
const u8 gText_LavenderTown[] = _("LAVENDER TOWN");
const u8 gText_VermilionCity[] = _("VERMILION CITY");
const u8 gText_CeladonCity[] = _("CELADON CITY");
const u8 gText_FuchsiaCity[] = _("FUCHSIA CITY");
const u8 gText_CinnabarIsland[] = _("CINNABAR ISLAND");
const u8 gText_IndigoPlateau[] = _("INDIGO PLATEAU");
const u8 gText_SaffronCity[] = _("SAFFRON CITY");
const u8 gText_Route1[] = _("ROUTE 1");
const u8 gText_Route2[] = _("ROUTE 2");
const u8 gText_Route3[] = _("ROUTE 3");
const u8 gText_Route4[] = _("ROUTE 4");
const u8 gText_Route5[] = _("ROUTE 5");
const u8 gText_Route6[] = _("ROUTE 6");
const u8 gText_Route7[] = _("ROUTE 7");
const u8 gText_Route8[] = _("ROUTE 8");
const u8 gText_Route9[] = _("ROUTE 9");
const u8 gText_Route10[] = _("ROUTE 10");
const u8 gText_Route11[] = _("ROUTE 11");
const u8 gText_Route12[] = _("ROUTE 12");
const u8 gText_Route13[] = _("ROUTE 13");
const u8 gText_Route14[] = _("ROUTE 14");
const u8 gText_Route15[] = _("ROUTE 15");
const u8 gText_Route16[] = _("ROUTE 16");
const u8 gText_Route17[] = _("ROUTE 17");
const u8 gText_Route18[] = _("ROUTE 18");
const u8 gText_Route19[] = _("ROUTE 19");
const u8 gText_Route20[] = _("ROUTE 20");
const u8 gText_Route21[] = _("ROUTE 21");
const u8 gText_Route22[] = _("ROUTE 22");
const u8 gText_Route23[] = _("ROUTE 23");
const u8 gText_Route24[] = _("ROUTE 24");
const u8 gText_Route25[] = _("ROUTE 25");
const u8 gText_ViridianForest[] = _("VIRIDIAN FOREST");
const u8 gText_MtMoon[] = _("MT. MOON");
const u8 gText_SSAnne[] = _("S.S. ANNE");
const u8 gText_UndergroundPath[] = _("UNDERGROUND PATH");
const u8 gText_DiglettsCave[] = _("DIGLETT'S CAVE");
const u8 gText_RocketHideout[] = _("ROCKET HIDEOUT");
const u8 gText_SilphCo[] = _("SILPH CO.");
const u8 gText_PokemonMansion[] = _("POKéMON MANSION");
const u8 gText_RockTunnel[] = _("ROCK TUNNEL");
const u8 gText_SeafoamIslands[] = _("SEAFOAM ISLANDS");
const u8 gText_PokemonTower[] = _("POKéMON TOWER");
const u8 gText_CeruleanCave[] = _("CERULEAN CAVE");
const u8 gText_PowerPlant[] = _("POWER PLANT");
...
const u8 gText_KindleRoad[] = _("KINDLE ROAD");
const u8 gText_TreasureBeach[] = _("TREASURE BEACH");
const u8 gText_CapeBrink[] = _("CAPE BRINK");
const u8 gText_BondBridge[] = _("BOND BRIDGE");
const u8 gText_ThreeIslePort[] = _("THREE ISLE PORT");
const u8 gText_SeviiIsle6[] = _("SEVII ISLE 6");
const u8 gText_SeviiIsle7[] = _("SEVII ISLE 7");
const u8 gText_SeviiIsle8[] = _("SEVII ISLE 8");
const u8 gText_SeviiIsle9[] = _("SEVII ISLE 9");
const u8 gText_ResortGorgeous[] = _("RESORT GORGEOUS");
const u8 gText_WaterLabyrinth[] = _("WATER LABYRINTH");
const u8 gText_FiveIsleMeadow[] = _("FIVE ISLE MEADOW");
const u8 gText_MemorialPillar[] = _("MEMORIAL PILLAR");
const u8 gText_OutcastIsland[] = _("OUTCAST ISLAND");
const u8 gText_GreenPath[] = _("GREEN PATH");
const u8 gText_WaterPath[] = _("WATER PATH");
const u8 gText_RuinValley[] = _("RUIN VALLEY");
const u8 gText_TrainerTower[] = _("TRAINER TOWER");
const u8 gText_CanyonEntrance[] = _("CANYON ENTRANCE");
const u8 gText_SevaultCanyon[] = _("SEVAULT CANYON");
const u8 gText_TanobyRuins[] = _("TANOBY RUINS");
const u8 gText_SeviiIsle22[] = _("SEVII ISLE 22");
const u8 gText_SeviiIsle23[] = _("SEVII ISLE 23");
const u8 gText_SeviiIsle24[] = _("SEVII ISLE 24");
const u8 gText_MtEmber[] = _("MT. EMBER");
const u8 gText_BerryForest[] = _("BERRY FOREST");
const u8 gText_IcefallCave[] = _("ICEFALL CAVE");
const u8 gText_RocketWarehouse[] = _("ROCKET WAREHOUSE");
const u8 gText_DottedHole[] = _("DOTTED HOLE");
const u8 gText_LostCave[] = _("LOST CAVE");
const u8 gText_PatternBush[] = _("PATTERN BUSH");
const u8 gText_AlteringCave[] = _("ALTERING CAVE");
const u8 gText_TanobyChambers[] = _("TANOBY CHAMBERS");
const u8 gText_ThreeIslePath[] = _("THREE ISLE PATH");
const u8 gText_TanobyKey[] = _("TANOBY KEY");
const u8 gText_MoneanChamber[] = _("MONEAN CHAMBER");
const u8 gText_LiptooChamber[] = _("LIPTOO CHAMBER");
const u8 gText_WeepthChamber[] = _("WEEPTH CHAMBER");
const u8 gText_DilfordChamber[] = _("DILFORD CHAMBER");
const u8 gText_ScufibChamber[] = _("SCUFIB CHAMBER");
const u8 gText_RixyChamber[] = _("RIXY CHAMBER");
const u8 gText_ViapoisChamber[] = _("VIAPOIS CHAMBER");
const u8 gText_EmberSpa[] = _("EMBER SPA");
const u8 gText_SpecialArea[] = _("SPECIAL AREA");
const u8 gText_MirageTower[] = _("MIRAGE TOWER");
const u8 gText_ArtisanCave[] = _("ARTISAN CAVE");
const u8 gText_MarineCave[] = _("MARINE CAVE");
const u8 gText_TerraCave[] = _("TERRA CAVE");
const u8 gText_DesertUnderpass[] = _("DESERT UNDERPASS");
const u8 gText_TrainerHill[] = _("TRAINER HILL");

// CrystalDust met location strings
const u8 gText_NewBarkTown[] = _("NEW BARK TOWN");
const u8 gText_CherrygroveCity[] = _("CHERRYGROVE CITY");
const u8 gText_AzaleaTown[] = _("AZALEA TOWN");
const u8 gText_CianwoodCity[] = _("CIANWOOD CITY");
const u8 gText_MahoganyTown[] = _("MAHOGANY TOWN");
const u8 gText_VioletCity[] = _("VIOLET CITY");
const u8 gText_EcruteakCity[] = _("ECRUTEAK CITY");
const u8 gText_OlivineCity[] = _("OLIVINE CITY");
const u8 gText_GoldenrodCity[] = _("GOLDENROD CITY");
const u8 gText_BlackthornCity[] = _("BLACKTHORN CITY");
const u8 gText_Route29[] = _("ROUTE 29");
const u8 gText_Route30[] = _("ROUTE 30");
const u8 gText_Route31[] = _("ROUTE 31");
const u8 gText_Route32[] = _("ROUTE 32");
const u8 gText_Route33[] = _("ROUTE 33");
const u8 gText_Route34[] = _("ROUTE 34");
const u8 gText_Route35[] = _("ROUTE 35");
const u8 gText_Route36[] = _("ROUTE 36");
const u8 gText_Route37[] = _("ROUTE 37");
const u8 gText_Route38[] = _("ROUTE 38");
const u8 gText_Route39[] = _("ROUTE 39");
const u8 gText_Route40[] = _("ROUTE 40");
const u8 gText_Route41[] = _("ROUTE 41");
const u8 gText_Route42[] = _("ROUTE 42");
const u8 gText_Route43[] = _("ROUTE 43");
const u8 gText_Route44[] = _("ROUTE 44");
const u8 gText_Route45[] = _("ROUTE 45");
const u8 gText_Route46[] = _("ROUTE 46");
const u8 gText_Route26[] = _("ROUTE 26");
const u8 gText_Route27[] = _("ROUTE 27");
const u8 gText_Route28[] = _("ROUTE 28");
const u8 gText_DarkCave[] = _("DARK CAVE");
const u8 gText_SlowpokeWell_B1F[] = _("SLOWPOKE WELL");
const u8 gText_IlexForest[] = _("ILEX FOREST");
const u8 gText_UnionCave[] = _("UNION CAVE");
const u8 gText_SproutTower[] = _("SPROUT TOWER");
const u8 gText_RuinsOfAlph[] = _("RUINS OF ALPH");
const u8 gText_AlphChambers[] = _("ALPH CHAMBERS");
const u8 gText_RadioTower[] = _("RADIO TOWER");
const u8 gText_MtMortar[] = _("MT. MORTAR");
const u8 gText_Lighthouse[] = _("LIGHTHOUSE");
const u8 gText_DragonsDen[] = _("DRAGON'S DEN");
const u8 gText_LakeOfRage[] = _("LAKE OF RAGE");
const u8 gText_NationalPark[] = _("NATIONAL PARK");
const u8 gText_IcePath[] = _("ICE PATH");
const u8 gText_SilverCave[] = _("SILVER CAVE");
const u8 gText_WhirlIslands[] = _("WHIRL ISLANDS");
const u8 gText_TinTower[] = _("TIN TOWER");
...
const u8 gText_LinkBattlesFR[] = _("LINK BATTLES                 W:");
const u8 gText_LinkBattles[] = _("LINK BATTLES");
const u8 gText_LinkCableBattles[] = _("LINK CABLE BATTLES   W:");
...
const u8 gText_LossRatio[] = _(" {COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_1}{COLOR DARK_GREY}{SHADOW LIGHT_GREY}   L:{CLEAR_TO 0x33}{COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_2}{COLOR DARK_GREY}{SHADOW LIGHT_GREY}");
