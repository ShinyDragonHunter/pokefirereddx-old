...
const u8 gText_ConfirmTossItems[] = _("Is it okay to throw away\n{STR_VAR_2} {STR_VAR_1}(s)?");
const u8 gText_DadsAdvice[] = _("OAK: {PLAYER}!\nThis isn't the time to use that!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TheField[] = _("field");
const u8 gText_TheBattle[] = _("battle");
const u8 gText_ThePokemonList[] = _("POKéMON LIST");
const u8 gText_TheShop[] = _("shop");
...
const u8 gText_ReturnToVar1[] = _("Close the bag and return to the\n{STR_VAR_1}.");
...
const u8 gText_EnergyPowder50[] = _("ENERGYPOWDER{CLEAR_TO 0x72}{FONT 4}50");
const u8 gText_EnergyRoot80[] = _("ENERGY ROOT{CLEAR_TO 0x72}{FONT 4}80");
const u8 gText_HealPowder50[] = _("HEAL POWDER{CLEAR_TO 0x72}{FONT 4}50");
const u8 gText_RevivalHerb300[] = _("REVIVAL HERB{CLEAR_TO 0x6C}{FONT 4}300");
const u8 gText_Protein1000[] = _("PROTEIN{CLEAR_TO 0x63}{FONT 4}1,000");
const u8 gText_Iron1000[] = _("IRON{CLEAR_TO 0x63}{FONT 4}1,000");
const u8 gText_Carbos1000[] = _("CARBOS{CLEAR_TO 0x63}{FONT 4}1,000");
const u8 gText_Calcium1000[] = _("CALCIUM{CLEAR_TO 0x63}{FONT 4}1,000");
const u8 gText_Zinc1000[] = _("ZINC{CLEAR_TO 0x63}{FONT 4}1,000");
const u8 gText_HPUp1000[] = _("HP UP{CLEAR_TO 0x63}{FONT 4}1,000");
const u8 gText_PPUp3000[] = _("PP UP{CLEAR_TO 0x63}{FONT 4}3,000");
...
const u8 gText_SaveFailedCheckingBackup[] = _("Save failed. Checking the backup memory… Please wait.\n{COLOR RED}“Time required: about 1 minute”");
...
const u8 gText_Protein1BP[] = _("PROTEIN{CLEAR_TO 0x64}{FONT 4}1BP");
const u8 gText_Calcium1BP[] = _("CALCIUM{CLEAR_TO 0x64}{FONT 4}1BP");
const u8 gText_Iron1BP[] = _("IRON{CLEAR_TO 0x64}{FONT 4}1BP");
const u8 gText_Zinc1BP[] = _("ZINC{CLEAR_TO 0x64}{FONT 4}1BP");
const u8 gText_Carbos1BP[] = _("CARBOS{CLEAR_TO 0x64}{FONT 4}1BP");
const u8 gText_HpUp1BP[] = _("HP UP{CLEAR_TO 0x64}{FONT 4}1BP");
const u8 gText_Leftovers48BP[] = _("LEFTOVERS{CLEAR_TO 0x5E}{FONT 4}48BP");
const u8 gText_WhiteHerb48BP[] = _("WHITE HERB{CLEAR_TO 0x5E}{FONT 4}48BP");
const u8 gText_QuickClaw48BP[] = _("QUICK CLAW{CLEAR_TO 0x5E}{FONT 4}48BP");
const u8 gText_MentalHerb48BP[] = _("MENTAL HERB{CLEAR_TO 0x5E}{FONT 4}48BP");
const u8 gText_BrightPowder64BP[] = _("BRIGHTPOWDER{CLEAR_TO 0x5E}{FONT 4}64BP");
const u8 gText_ChoiceBand64BP[] = _("CHOICE BAND{CLEAR_TO 0x5E}{FONT 4}64BP");
const u8 gText_KingsRock64BP[] = _("KING'S ROCK{CLEAR_TO 0x5E}{FONT 4}64BP");
const u8 gText_FocusBand64BP[] = _("FOCUS BAND{CLEAR_TO 0x5E}{FONT 4}64BP");
const u8 gText_ScopeLens64BP[] = _("SCOPE LENS{CLEAR_TO 0x5E}{FONT 4}64BP");
const u8 gText_Softboiled16BP[] = _("SOFTBOILED{CLEAR_TO 0x4E}{FONT 4}16BP");
const u8 gText_SeismicToss24BP[] = _("SEISMIC TOSS{CLEAR_TO 0x4E}{FONT 4}24BP");
const u8 gText_DreamEater24BP[] = _("DREAM EATER{CLEAR_TO 0x4E}{FONT 4}24BP");
const u8 gText_MegaPunch24BP[] = _("MEGA PUNCH{CLEAR_TO 0x4E}{FONT 4}24BP");
const u8 gText_MegaKick48BP[] = _("MEGA KICK{CLEAR_TO 0x4E}{FONT 4}48BP");
const u8 gText_BodySlam48BP[] = _("BODY SLAM{CLEAR_TO 0x4E}{FONT 4}48BP");
const u8 gText_RockSlide48BP[] = _("ROCK SLIDE{CLEAR_TO 0x4E}{FONT 4}48BP");
const u8 gText_Counter48BP[] = _("COUNTER{CLEAR_TO 0x4E}{FONT 4}48BP");
const u8 gText_ThunderWave48BP[] = _("THUNDER WAVE{CLEAR_TO 0x4E}{FONT 4}48BP");
const u8 gText_SwordsDance48BP[] = _("SWORDS DANCE{CLEAR_TO 0x4E}{FONT 4}48BP");
const u8 gText_DefenseCurl16BP[] = _("DEFENSE CURL{CLEAR_TO 0x4E}{FONT 4}16BP");
const u8 gText_Snore24BP[] = _("SNORE{CLEAR_TO 0x4E}{FONT 4}24BP");
const u8 gText_MudSlap24BP[] = _("MUD-SLAP{CLEAR_TO 0x4E}{FONT 4}24BP");
const u8 gText_Swift24BP[] = _("SWIFT{CLEAR_TO 0x4E}{FONT 4}24BP");
const u8 gText_IcyWind24BP[] = _("ICY WIND{CLEAR_TO 0x4E}{FONT 4}24BP");
const u8 gText_Endure48BP[] = _("ENDURE{CLEAR_TO 0x4E}{FONT 4}48BP");
const u8 gText_PsychUp48BP[] = _("PSYCH UP{CLEAR_TO 0x4E}{FONT 4}48BP");
const u8 gText_IcePunch48BP[] = _("ICE PUNCH{CLEAR_TO 0x4E}{FONT 4}48BP");
const u8 gText_ThunderPunch48BP[] = _("THUNDERPUNCH{CLEAR_TO 0x4E}{FONT 4}48BP");
const u8 gText_FirePunch48BP[] = _("FIRE PUNCH{CLEAR_TO 0x4E}{FONT 4}48BP");
const u8 gText_PkmnFainted3[] = _("{STR_VAR_1} fainted…\p\n");
const u8 gText_Marco[] = _("MARCO");
const u8 gText_FRLGTrainerCardName[] = _("NAME:  ");
const u8 gText_TrainerCardName[] = _("NAME: ");
const u8 gText_RSTrainerCardName[] = _("NAME");
const u8 gText_HeliodorTrainerCardName[] = _("TRAINER:{CLEAR_TO 3}{STR_VAR_1}");
...
const u8 gText_FRLGPokemonTrades[] = _("POKéMON  TRADES");
const u8 gText_PokemonTrades[] = _("POKéMON TRADES");
const u8 gText_FRLGUnionTradesAndBattles[] = _("UNION  TRADES  &  BATTLES");
const u8 gText_UnionTradesAndBattles[] = _("UNION TRADES & BATTLES");
const u8 gText_FRLGBerryCrush[] = _("BERRY  CRUSH");
...
const u8 gText_CDPokeblocksWithFriends[] = _("{POKEBLOCK}S  W/FRIENDS");
...
const u8 gText_CDWonContestsWFriends[] = _("WON  CONTESTS  W/FRIENDS");
...
#if UK
const u8 gText_ShinyCount[] = _("ALT. COLOUR POKéMON FOUND");
#else
...
const u8 gText_UnableConnectWithEReader[] = _("Unable to connect to the e-Reader.");
