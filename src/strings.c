...
const u8 gText_MainMenuGameCube[] = _("GAMECUBE CONNECTION");
...
const u8 gMenuText_SelectButton[] = _("{SELECT_BUTTON}");
const u8 gMenuText_LButton[] = _("{L_BUTTON}");
const u8 gMenuText_RButton[] = _("{R_BUTTON}");
...
const u8 gText_PlayedPokeFluteCatchyTune[] = _("Played the POKé FLUTE.\pNow, that's a catchy tune!{PAUSE_UNTIL_PRESS}");
const u8 gText_PlayedPokeFlute[] = _("Played the POKé FLUTE.");
const u8 gText_PokeFluteAwakened[] = _("The POKé FLUTE awakened sleeping\nPOKéMON.{PAUSE_UNTIL_PRESS}");
