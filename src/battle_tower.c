...
{
    FACILITY_CLASS_HOENN_RUIN_MANIAC,
    FACILITY_CLASS_HOENN_TUBER_M,
    FACILITY_CLASS_HOENN_COOLTRAINER_M,
    FACILITY_CLASS_HOENN_RICH_BOY,
    FACILITY_CLASS_HOENN_POKEMANIAC,
    FACILITY_CLASS_HOENN_SWIMMER_M,
    FACILITY_CLASS_HOENN_BLACK_BELT,
    FACILITY_CLASS_HOENN_GUITARIST,
    FACILITY_CLASS_HOENN_KINDLER,
    FACILITY_CLASS_HOENN_CAMPER,
    FACILITY_CLASS_HOENN_BUG_MANIAC,
    FACILITY_CLASS_HOENN_PSYCHIC_M,
    FACILITY_CLASS_HOENN_GENTLEMAN,
    FACILITY_CLASS_HOENN_SCHOOL_KID_M,
    FACILITY_CLASS_HOENN_POKEFAN_M,
    FACILITY_CLASS_HOENN_EXPERT_M,
    FACILITY_CLASS_HOENN_YOUNGSTER,
    FACILITY_CLASS_HOENN_FISHERMAN,
    FACILITY_CLASS_HOENN_CYCLING_TRIATHLETE_M,
    FACILITY_CLASS_HOENN_RUNNING_TRIATHLETE_M,
    FACILITY_CLASS_HOENN_SWIMMING_TRIATHLETE_M,
    FACILITY_CLASS_HOENN_DRAGON_TAMER,
    FACILITY_CLASS_HOENN_BIRD_KEEPER,
    FACILITY_CLASS_HOENN_NINJA_BOY,
    FACILITY_CLASS_HOENN_SAILOR,
    FACILITY_CLASS_HOENN_COLLECTOR,
    FACILITY_CLASS_HOENN_PKMN_BREEDER_M,
    FACILITY_CLASS_HOENN_PKMN_RANGER_M,
    FACILITY_CLASS_HOENN_BUG_CATCHER,
    FACILITY_CLASS_HOENN_HIKER
};

const u8 gTowerFemaleFacilityClasses[20] =
{
    FACILITY_CLASS_HOENN_AROMA_LADY,
    FACILITY_CLASS_HOENN_TUBER_F,
    FACILITY_CLASS_HOENN_COOLTRAINER_F,
    FACILITY_CLASS_HOENN_HEX_MANIAC,
    FACILITY_CLASS_HOENN_LADY,
    FACILITY_CLASS_HOENN_BEAUTY,
    FACILITY_CLASS_HOENN_PSYCHIC_F,
    FACILITY_CLASS_HOENN_SCHOOL_KID_F,
    FACILITY_CLASS_HOENN_POKEFAN_F,
    FACILITY_CLASS_HOENN_EXPERT_F,
    FACILITY_CLASS_HOENN_CYCLING_TRIATHLETE_F,
    FACILITY_CLASS_HOENN_RUNNING_TRIATHLETE_F,
    FACILITY_CLASS_HOENN_SWIMMING_TRIATHLETE_F,
    FACILITY_CLASS_HOENN_BATTLE_GIRL,
    FACILITY_CLASS_HOENN_PARASOL_LADY,
    FACILITY_CLASS_HOENN_SWIMMER_F,
    FACILITY_CLASS_HOENN_PICNICKER,
    FACILITY_CLASS_HOENN_PKMN_BREEDER_F,
    FACILITY_CLASS_HOENN_PKMN_RANGER_F,
...
{
    {RS_FACILITY_CLASS_AQUA_LEADER_ARCHIE, FACILITY_CLASS_AQUA_LEADER},
    {RS_FACILITY_CLASS_AQUA_GRUNT_M, FACILITY_CLASS_FIREBREATHER},
    {RS_FACILITY_CLASS_AQUA_GRUNT_F, FACILITY_CLASS_AQUA_GRUNT_F},
    {RS_FACILITY_CLASS_AROMA_LADY, FACILITY_CLASS_HOENN_AROMA_LADY},
    {RS_FACILITY_CLASS_RUIN_MANIAC, FACILITY_CLASS_HOENN_RUIN_MANIAC},
    {RS_FACILITY_CLASS_INTERVIEWER, FACILITY_CLASS_HOENN_INTERVIEWER},
    {RS_FACILITY_CLASS_TUBER_F, FACILITY_CLASS_HOENN_TUBER_F},
    {RS_FACILITY_CLASS_TUBER_M, FACILITY_CLASS_HOENN_TUBER_M},
    {RS_FACILITY_CLASS_COOLTRAINER_M, FACILITY_CLASS_HOENN_COOLTRAINER_M},
    {RS_FACILITY_CLASS_COOLTRAINER_F, FACILITY_CLASS_HOENN_COOLTRAINER_F},
    {RS_FACILITY_CLASS_HEX_MANIAC, FACILITY_CLASS_HOENN_HEX_MANIAC},
    {RS_FACILITY_CLASS_LADY, FACILITY_CLASS_HOENN_LADY},
    {RS_FACILITY_CLASS_BEAUTY, FACILITY_CLASS_HOENN_BEAUTY},
    {RS_FACILITY_CLASS_RICH_BOY, FACILITY_CLASS_HOENN_RICH_BOY},
    {RS_FACILITY_CLASS_POKEMANIAC, FACILITY_CLASS_HOENN_POKEMANIAC},
    {RS_FACILITY_CLASS_SWIMMER_M, FACILITY_CLASS_HOENN_SWIMMER_M},
    {RS_FACILITY_CLASS_BLACK_BELT, FACILITY_CLASS_HOENN_BLACK_BELT},
    {RS_FACILITY_CLASS_GUITARIST, FACILITY_CLASS_HOENN_GUITARIST},
    {RS_FACILITY_CLASS_KINDLER, FACILITY_CLASS_HOENN_KINDLER},
    {RS_FACILITY_CLASS_CAMPER, FACILITY_CLASS_HOENN_CAMPER},
    {RS_FACILITY_CLASS_BUG_MANIAC, FACILITY_CLASS_HOENN_BUG_MANIAC},
    {RS_FACILITY_CLASS_PSYCHIC_M, FACILITY_CLASS_HOENN_PSYCHIC_M},
    {RS_FACILITY_CLASS_PSYCHIC_F, FACILITY_CLASS_HOENN_PSYCHIC_F},
    {RS_FACILITY_CLASS_GENTLEMAN, FACILITY_CLASS_HOENN_GENTLEMAN},
    ...
    {RS_FACILITY_CLASS_SCHOOL_KID_M, FACILITY_CLASS_HOENN_SCHOOL_KID_M},
    {RS_FACILITY_CLASS_SCHOOL_KID_F, FACILITY_CLASS_HOENN_SCHOOL_KID_F},
    {RS_FACILITY_CLASS_SR_AND_JR, FACILITY_CLASS_HOENN_SR_AND_JR},
    {RS_FACILITY_CLASS_POKEFAN_M, FACILITY_CLASS_HOENN_POKEFAN_M},
    {RS_FACILITY_CLASS_POKEFAN_F, FACILITY_CLASS_HOENN_POKEFAN_F},
    {RS_FACILITY_CLASS_EXPERT_M, FACILITY_CLASS_HOENN_EXPERT_M},
    {RS_FACILITY_CLASS_EXPERT_F, FACILITY_CLASS_HOENN_EXPERT_F},
    {RS_FACILITY_CLASS_YOUNGSTER, FACILITY_CLASS_HOENN_YOUNGSTER},
    {RS_FACILITY_CLASS_CHAMPION, FACILITY_CLASS_HOENN_CHAMPION},
    {RS_FACILITY_CLASS_FISHERMAN, FACILITY_CLASS_HOENN_FISHERMAN},
    {RS_FACILITY_CLASS_CYCLING_TRIATHLETE_M, FACILITY_CLASS_HOENN_CYCLING_TRIATHLETE_M},
    {RS_FACILITY_CLASS_CYCLING_TRIATHLETE_F, FACILITY_CLASS_HOENN_CYCLING_TRIATHLETE_F},
    {RS_FACILITY_CLASS_RUNNING_TRIATHLETE_M, FACILITY_CLASS_HOENN_RUNNING_TRIATHLETE_M},
    {RS_FACILITY_CLASS_RUNNING_TRIATHLETE_F, FACILITY_CLASS_HOENN_RUNNING_TRIATHLETE_F},
    {RS_FACILITY_CLASS_SWIMMING_TRIATHLETE_M, FACILITY_CLASS_HOENN_SWIMMING_TRIATHLETE_M},
    {RS_FACILITY_CLASS_SWIMMING_TRIATHLETE_F, FACILITY_CLASS_HOENN_SWIMMING_TRIATHLETE_F},
    {RS_FACILITY_CLASS_DRAGON_TAMER, FACILITY_CLASS_HOENN_DRAGON_TAMER},
    {RS_FACILITY_CLASS_BIRD_KEEPER, FACILITY_CLASS_HOENN_BIRD_KEEPER},
    {RS_FACILITY_CLASS_NINJA_BOY, FACILITY_CLASS_HOENN_NINJA_BOY},
    {RS_FACILITY_CLASS_BATTLE_GIRL, FACILITY_CLASS_HOENN_BATTLE_GIRL},
    {RS_FACILITY_CLASS_PARASOL_LADY, FACILITY_CLASS_HOENN_PARASOL_LADY},
    {RS_FACILITY_CLASS_SWIMMER_F, FACILITY_CLASS_HOENN_SWIMMER_F},
    {RS_FACILITY_CLASS_PICNICKER, FACILITY_CLASS_HOENN_PICNICKER},
    {RS_FACILITY_CLASS_SAILOR, FACILITY_CLASS_HOENN_SAILOR},
    {RS_FACILITY_CLASS_COLLECTOR, FACILITY_CLASS_HOENN_COLLECTOR},
    {RS_FACILITY_CLASS_WALLY, FACILITY_CLASS_WALLY},
    {RS_FACILITY_CLASS_BRENDAN_1, FACILITY_CLASS_E_BRENDAN},
    {RS_FACILITY_CLASS_BRENDAN_2, FACILITY_CLASS_BRENDAN_2},
    {RS_FACILITY_CLASS_BRENDAN_3, FACILITY_CLASS_BRENDAN_3},
    {RS_FACILITY_CLASS_MAY_1, FACILITY_CLASS_E_MAY},
    {RS_FACILITY_CLASS_MAY_2, FACILITY_CLASS_MAY_2},
    {RS_FACILITY_CLASS_MAY_3, FACILITY_CLASS_MAY_3},
    {RS_FACILITY_CLASS_PKMN_BREEDER_M, FACILITY_CLASS_HOENN_PKMN_BREEDER_M},
    {RS_FACILITY_CLASS_PKMN_BREEDER_F, FACILITY_CLASS_HOENN_PKMN_BREEDER_F},
    {RS_FACILITY_CLASS_PKMN_RANGER_M, FACILITY_CLASS_HOENN_PKMN_RANGER_M},
    {RS_FACILITY_CLASS_PKMN_RANGER_F, FACILITY_CLASS_HOENN_PKMN_RANGER_F},
    {RS_FACILITY_CLASS_MAGMA_LEADER, FACILITY_CLASS_MAGMA_LEADER},
    {RS_FACILITY_CLASS_MAGMA_GRUNT_M, FACILITY_CLASS_MAGMA_GRUNT_M},
    {RS_FACILITY_CLASS_MAGMA_GRUNT_F, FACILITY_CLASS_MAGMA_GRUNT_F},
    {RS_FACILITY_CLASS_LASS, FACILITY_CLASS_HOENN_LASS},
    {RS_FACILITY_CLASS_BUG_CATCHER, FACILITY_CLASS_HOENN_BUG_CATCHER},
    {RS_FACILITY_CLASS_HIKER, FACILITY_CLASS_HOENN_HIKER},
    {RS_FACILITY_CLASS_YOUNG_COUPLE, FACILITY_CLASS_HOENN_YOUNG_COUPLE},
    {RS_FACILITY_CLASS_OLD_COUPLE, FACILITY_CLASS_HOENN_OLD_COUPLE},
    {RS_FACILITY_CLASS_SIS_AND_BRO, FACILITY_CLASS_HOENN_SIS_AND_BRO},
};
...
{
    {FACILITY_CLASS_HOENN_LASS,                  sPartnerTextsLass},
    {FACILITY_CLASS_HOENN_YOUNGSTER,             sPartnerTextsYoungster},
    {FACILITY_CLASS_HOENN_HIKER,                 sPartnerTextsHiker},
    {FACILITY_CLASS_HOENN_BEAUTY,                sPartnerTextsBeauty},
    {FACILITY_CLASS_HOENN_FISHERMAN,             sPartnerTextsFisherman},
    {FACILITY_CLASS_HOENN_LADY,                  sPartnerTextsLady},
    {FACILITY_CLASS_HOENN_CYCLING_TRIATHLETE_F,  sPartnerTextsCyclingTriathleteF},
    {FACILITY_CLASS_HOENN_BUG_CATCHER,           sPartnerTextsBugCatcher},
    {FACILITY_CLASS_HOENN_SCHOOL_KID_M,          sPartnerTextsSchoolKidM},
    {FACILITY_CLASS_HOENN_RICH_BOY,              sPartnerTextsRichBoy},
    {FACILITY_CLASS_HOENN_BLACK_BELT,            sPartnerTextsBlackBelt},
    {FACILITY_CLASS_HOENN_TUBER_F,               sPartnerTextsTuberF},
    {FACILITY_CLASS_HOENN_HEX_MANIAC,            sPartnerTextsHexManiac},
    {FACILITY_CLASS_HOENN_PKMN_BREEDER_M,        sPartnerTextsPkmnBreederM},
    {FACILITY_CLASS_HOENN_RUNNING_TRIATHLETE_F,  sPartnerTextsRunningTriathleteF},
    {FACILITY_CLASS_HOENN_RUNNING_TRIATHLETE_M,  sPartnerTextsRunningTriathleteM},
    {FACILITY_CLASS_HOENN_BATTLE_GIRL,           sPartnerTextsBattleGirl},
    {FACILITY_CLASS_HOENN_CYCLING_TRIATHLETE_M,  sPartnerTextsCyclingTriathleteM},
    {FACILITY_CLASS_HOENN_TUBER_M,               sPartnerTextsTuberM},
    {FACILITY_CLASS_HOENN_GUITARIST,             sPartnerTextsGuitarist},
    {FACILITY_CLASS_HOENN_GENTLEMAN,             sPartnerTextsGentleman},
    {FACILITY_CLASS_HOENN_POKEFAN_M,             sPartnerTextsPokefanM},
    {FACILITY_CLASS_HOENN_EXPERT_M,              sPartnerTextsExpertM},
    {FACILITY_CLASS_HOENN_EXPERT_F,              sPartnerTextsExpertF},
    {FACILITY_CLASS_HOENN_DRAGON_TAMER,          sPartnerTextsDragonTamer},
    {FACILITY_CLASS_HOENN_BIRD_KEEPER,           sPartnerTextsBirdKeeper},
    {FACILITY_CLASS_HOENN_NINJA_BOY,             sPartnerTextsNinjaBoy},
    {FACILITY_CLASS_HOENN_PARASOL_LADY,          sPartnerTextsParasolLady},
    {FACILITY_CLASS_HOENN_BUG_MANIAC,            sPartnerTextsBugManiac},
    {FACILITY_CLASS_HOENN_SAILOR,                sPartnerTextsSailor},
    {FACILITY_CLASS_HOENN_COLLECTOR,             sPartnerTextsCollector},
    {FACILITY_CLASS_HOENN_PKMN_RANGER_M,         sPartnerTextsPkmnRangerM},
    {FACILITY_CLASS_HOENN_PKMN_RANGER_F,         sPartnerTextsPkmnRangerF},
    {FACILITY_CLASS_HOENN_AROMA_LADY,            sPartnerTextsAromaLady},
    {FACILITY_CLASS_HOENN_RUIN_MANIAC,           sPartnerTextsRuinManiac},
    {FACILITY_CLASS_HOENN_COOLTRAINER_M,         sPartnerTextsCoolTrainerM},
    {FACILITY_CLASS_HOENN_COOLTRAINER_F,         sPartnerTextsCoolTrainerF},
    {FACILITY_CLASS_HOENN_POKEMANIAC,            sPartnerTextsPokemaniac},
    {FACILITY_CLASS_HOENN_KINDLER,               sPartnerTextsKindler},
    {FACILITY_CLASS_HOENN_CAMPER,                sPartnerTextsCamper},
    {FACILITY_CLASS_HOENN_PICNICKER,             sPartnerTextsPicnicker},
    {FACILITY_CLASS_HOENN_PSYCHIC_M,             sPartnerTextsPsychicM},
    {FACILITY_CLASS_HOENN_PSYCHIC_F,             sPartnerTextsPsychicF},
    {FACILITY_CLASS_HOENN_SCHOOL_KID_F,          sPartnerTextsSchoolKidF},
    {FACILITY_CLASS_HOENN_PKMN_BREEDER_F,        sPartnerTextsPkmnBreederF},
    {FACILITY_CLASS_HOENN_POKEFAN_F,             sPartnerTextsPokefanF},
    {FACILITY_CLASS_HOENN_SWIMMER_F,             sPartnerTextsSwimmerF},
    {FACILITY_CLASS_HOENN_SWIMMING_TRIATHLETE_M, sPartnerTextsSwimmingTriathleteM},
    {FACILITY_CLASS_HOENN_SWIMMING_TRIATHLETE_F, sPartnerTextsSwimmingTriathleteF},
    {FACILITY_CLASS_HOENN_SWIMMER_M,             sPartnerTextsSwimmerM}
};
...
void SetBattleFacilityTrainerGfxId(u16 trainerId, u8 tempVarId)
{
    ...
    {
    case 1:
        VarSet(VAR_OBJ_GFX_ID_1, OBJ_EVENT_GFX_HOENN_BOY_1);
        return;
    case 15:
        VarSet(VAR_OBJ_GFX_ID_E, OBJ_EVENT_GFX_HOENN_BOY_1);
        return;
    default:
        VarSet(VAR_OBJ_GFX_ID_0, OBJ_EVENT_GFX_HOENN_BOY_1);
        return;
    }
}
...
u16 GetBattleFacilityTrainerGfxId(u16 trainerId)
{
    ...
    return OBJ_EVENT_GFX_HOENN_BOY_1;
}
...
void DoSpecialTrainerBattle(void)
{
    ...
    case SPECIAL_BATTLE_TOWER:
        ...
        BattleTransition_StartOnField(GetSpecialBattleTransition(SPECIAL_BATTLE_TOWER));
        break;
    case SPECIAL_BATTLE_EREADER:
        ZeroEnemyPartyMons();
        for (i = 0; i < 3; i++)
...
static void SaveTowerChallenge(void)
{
    ...
    if (!gSpecialVar_0x8005 && (challengeNum > 1 || gSaveBlock2Ptr->frontier.curChallengeBattleNum))
...
bool32 RubyBattleTowerRecordToEmerald(struct RSBattleTowerRecord *src, struct EmeraldBattleTowerRecord *dst)
{
    ...
    else
    {
        ...
        if (i != FACILITY_CLASSES_HOENN_COUNT)
            dst->facilityClass = sRubyFacilityClassToEmerald[i][1];
        else
            dst->facilityClass = FACILITY_CLASS_HOENN_YOUNGSTER;
