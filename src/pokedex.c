...
{
    {gText_ExpandedPlaceholder_Empty, gText_DexSearchDontSpecify},
    [NAME_ABC] = {gText_ExpandedPlaceholder_Empty, gText_DexSearchAlphaABC},
    [NAME_DEF] = {gText_ExpandedPlaceholder_Empty, gText_DexSearchAlphaDEF},
    [NAME_GHI] = {gText_ExpandedPlaceholder_Empty, gText_DexSearchAlphaGHI},
    [NAME_JKL] = {gText_ExpandedPlaceholder_Empty, gText_DexSearchAlphaJKL},
    [NAME_MNO] = {gText_ExpandedPlaceholder_Empty, gText_DexSearchAlphaMNO},
    [NAME_PQR] = {gText_ExpandedPlaceholder_Empty, gText_DexSearchAlphaPQR},
    [NAME_STU] = {gText_ExpandedPlaceholder_Empty, gText_DexSearchAlphaSTU},
    [NAME_VWX] = {gText_ExpandedPlaceholder_Empty, gText_DexSearchAlphaVWX},
    [NAME_YZ]  = {gText_ExpandedPlaceholder_Empty, gText_DexSearchAlphaYZ},
    {},
};
...
{
    {gText_ExpandedPlaceholder_Empty, gText_DexSearchDontSpecify},
    [BODY_COLOR_RED + 1]    = {gText_ExpandedPlaceholder_Empty, gText_DexSearchColorRed},
    [BODY_COLOR_BLUE + 1]   = {gText_ExpandedPlaceholder_Empty, gText_DexSearchColorBlue},
    [BODY_COLOR_YELLOW + 1] = {gText_ExpandedPlaceholder_Empty, gText_DexSearchColorYellow},
    [BODY_COLOR_GREEN + 1]  = {gText_ExpandedPlaceholder_Empty, gText_DexSearchColorGreen},
    [BODY_COLOR_BLACK + 1]  = {gText_ExpandedPlaceholder_Empty, gText_DexSearchColorBlack},
    [BODY_COLOR_BROWN + 1]  = {gText_ExpandedPlaceholder_Empty, gText_DexSearchColorBrown},
    [BODY_COLOR_PURPLE + 1] = {gText_ExpandedPlaceholder_Empty, gText_DexSearchColorPurple},
    [BODY_COLOR_GRAY + 1]   = {gText_ExpandedPlaceholder_Empty, gText_DexSearchColorGray},
    [BODY_COLOR_WHITE + 1]  = {gText_ExpandedPlaceholder_Empty, gText_DexSearchColorWhite},
    [BODY_COLOR_PINK + 1]   = {gText_ExpandedPlaceholder_Empty, gText_DexSearchColorPink},
    {},
};

static const struct SearchOptionText sDexSearchTypeOptions[NUMBER_OF_MON_TYPES + 1] = // + 2 for "None" and terminator, - 1 for Mystery
{
    {gText_ExpandedPlaceholder_Empty, gText_DexSearchTypeNone},
    {gText_ExpandedPlaceholder_Empty, gTypeNames[TYPE_NORMAL]},
    {gText_ExpandedPlaceholder_Empty, gTypeNames[TYPE_FIGHTING]},
    {gText_ExpandedPlaceholder_Empty, gTypeNames[TYPE_FLYING]},
    {gText_ExpandedPlaceholder_Empty, gTypeNames[TYPE_POISON]},
    {gText_ExpandedPlaceholder_Empty, gTypeNames[TYPE_GROUND]},
    {gText_ExpandedPlaceholder_Empty, gTypeNames[TYPE_ROCK]},
    {gText_ExpandedPlaceholder_Empty, gTypeNames[TYPE_BUG]},
    {gText_ExpandedPlaceholder_Empty, gTypeNames[TYPE_GHOST]},
    {gText_ExpandedPlaceholder_Empty, gTypeNames[TYPE_STEEL]},
    {gText_ExpandedPlaceholder_Empty, gTypeNames[TYPE_FIRE]},
    {gText_ExpandedPlaceholder_Empty, gTypeNames[TYPE_WATER]},
    {gText_ExpandedPlaceholder_Empty, gTypeNames[TYPE_GRASS]},
    {gText_ExpandedPlaceholder_Empty, gTypeNames[TYPE_ELECTRIC]},
    {gText_ExpandedPlaceholder_Empty, gTypeNames[TYPE_PSYCHIC]},
    {gText_ExpandedPlaceholder_Empty, gTypeNames[TYPE_ICE]},
    {gText_ExpandedPlaceholder_Empty, gTypeNames[TYPE_DRAGON]},
    {gText_ExpandedPlaceholder_Empty, gTypeNames[TYPE_DARK]},
    {},
};
...
static void Task_LoadSizeScreen(u8 taskId)
{
    ...
    case 4:
        ...
        break;
    case 5:
        spriteId = CreateSizeScreenTrainerPic(PlayerGenderToFrontTrainerPicId(gSaveBlock2Ptr->playerGender, gSaveBlock2Ptr->playerOutfit), 152, 56, 0);
        gSprites[spriteId].oam.affineMode = ST_OAM_AFFINE_NORMAL;
...
static void Task_ExitCaughtMonPage(u8 taskId)
{
    if (!gPaletteFade.active)
    {
        ...
        LoadPalette(GetMonSpritePalFromSpeciesAndPersonality(species, otId, personality), (paletteNum * 16) + 0x100, 32);
        DestroyTask(taskId);
    }
}
...
// All others use personality 0xFF
static u32 GetPokedexMonPersonality(u16 species)
{
    if (species == SPECIES_UNOWN)
        ...
        return 0xFF; // Changed from 0 so the Pokédex shows the default Pokémon pics instead of the female versions.
}

u16 CreateMonSpriteFromNationalDexNumber(u16 nationalNum, s16 x, s16 y, u16 paletteSlot)
{
    nationalNum = NationalPokedexNumToSpecies(nationalNum);
    return CreateMonPicSprite(nationalNum, SHINY_ODDS, GetPokedexMonPersonality(nationalNum), TRUE, x, y, paletteSlot, 0xFFFF, 0);
}
