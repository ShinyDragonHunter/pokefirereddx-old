...
const struct SpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(EXPERT_M, gTrainerPalette_Expert),
    ...
    TRAINER_PAL(EXPERT_F, gTrainerPalette_Expert),
    ...
    TRAINER_PAL(PICNICKER, gTrainerPalette_Camper),
    ...
    TRAINER_PAL(SWIMMING_TRIATHLETE_M, gTrainerPalette_RunningTriathleteF),
    TRAINER_PAL(SWIMMING_TRIATHLETE_F, gTrainerPalette_RunningTriathleteF),
    ...
    TRAINER_PAL(OLD_COUPLE, gTrainerPalette_Expert),
    ...
    TRAINER_PAL(LEAF, gTrainerPalette_Red),
