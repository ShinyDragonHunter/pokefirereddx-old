...
const u8 *const gJohtoRegionMapNames[] = {
    [JOHTO_MAPSEC_NEW_BARK_TOWN - JOHTO_MAPSEC_START]              = sMapName_NewBarkTown,
    [JOHTO_MAPSEC_CHERRYGROVE_CITY - JOHTO_MAPSEC_START]           = sMapName_CherrygroveCity,
    [JOHTO_MAPSEC_AZALEA_TOWN - JOHTO_MAPSEC_START]                = sMapName_AzaleaTown,
    [JOHTO_MAPSEC_CIANWOOD_CITY - JOHTO_MAPSEC_START]              = sMapName_CianwoodCity,
    [JOHTO_MAPSEC_MAHOGANY_TOWN - JOHTO_MAPSEC_START]              = sMapName_MahoganyTown,
    [JOHTO_MAPSEC_VERDANTURF_TOWN - JOHTO_MAPSEC_START]            = sMapName_VerdanturfTown,
    [JOHTO_MAPSEC_PACIFIDLOG_TOWN - JOHTO_MAPSEC_START]            = sMapName_PacifidlogTown,
    [JOHTO_MAPSEC_VIOLET_CITY - JOHTO_MAPSEC_START]                = sMapName_VioletCity,
    [JOHTO_MAPSEC_ECRUTEAK_CITY - JOHTO_MAPSEC_START]              = sMapName_EcruteakCity,
    [JOHTO_MAPSEC_OLIVINE_CITY - JOHTO_MAPSEC_START]               = sMapName_OlivineCity,
    [JOHTO_MAPSEC_GOLDENROD_CITY - JOHTO_MAPSEC_START]             = sMapName_GoldenrodCity,
    [JOHTO_MAPSEC_FORTREE_CITY - JOHTO_MAPSEC_START]               = sMapName_FortreeCity,
    [JOHTO_MAPSEC_BLACKTHORN_CITY - JOHTO_MAPSEC_START]            = sMapName_BlackthornCity,
    [JOHTO_MAPSEC_MOSSDEEP_CITY - JOHTO_MAPSEC_START]              = sMapName_MossdeepCity,
    [JOHTO_MAPSEC_SOOTOPOLIS_CITY - JOHTO_MAPSEC_START]            = sMapName_SootopolisCity,
    [JOHTO_MAPSEC_EVER_GRANDE_CITY - JOHTO_MAPSEC_START]           = sMapName_EverGrandeCity,
    [JOHTO_MAPSEC_ROUTE_29 - JOHTO_MAPSEC_START]                   = sMapName_Route29,
    [JOHTO_MAPSEC_ROUTE_30 - JOHTO_MAPSEC_START]                   = sMapName_Route30,
    [JOHTO_MAPSEC_ROUTE_31 - JOHTO_MAPSEC_START]                   = sMapName_Route31,
    [JOHTO_MAPSEC_ROUTE_32 - JOHTO_MAPSEC_START]                   = sMapName_Route32,
    [JOHTO_MAPSEC_ROUTE_33 - JOHTO_MAPSEC_START]                   = sMapName_Route33,
    [JOHTO_MAPSEC_ROUTE_34 - JOHTO_MAPSEC_START]                   = sMapName_Route34,
    [JOHTO_MAPSEC_ROUTE_35 - JOHTO_MAPSEC_START]                   = sMapName_Route35,
    [JOHTO_MAPSEC_ROUTE_36 - JOHTO_MAPSEC_START]                   = sMapName_Route36,
    [JOHTO_MAPSEC_ROUTE_37 - JOHTO_MAPSEC_START]                   = sMapName_Route37,
    [JOHTO_MAPSEC_ROUTE_38 - JOHTO_MAPSEC_START]                   = sMapName_Route38,
    [JOHTO_MAPSEC_ROUTE_39 - JOHTO_MAPSEC_START]                   = sMapName_Route39,
    [JOHTO_MAPSEC_ROUTE_40 - JOHTO_MAPSEC_START]                   = sMapName_Route40,
    [JOHTO_MAPSEC_ROUTE_41 - JOHTO_MAPSEC_START]                   = sMapName_Route41,
    [JOHTO_MAPSEC_ROUTE_42 - JOHTO_MAPSEC_START]                   = sMapName_Route42,
    [JOHTO_MAPSEC_ROUTE_43 - JOHTO_MAPSEC_START]                   = sMapName_Route43,
    [JOHTO_MAPSEC_ROUTE_44 - JOHTO_MAPSEC_START]                   = sMapName_Route44,
    [JOHTO_MAPSEC_ROUTE_45 - JOHTO_MAPSEC_START]                   = sMapName_Route45,
    [JOHTO_MAPSEC_ROUTE_46 - JOHTO_MAPSEC_START]                   = sMapName_Route46,
    [JOHTO_MAPSEC_ROUTE_26 - JOHTO_MAPSEC_START]                   = sMapName_Route26,
    [JOHTO_MAPSEC_ROUTE_27 - JOHTO_MAPSEC_START]                   = sMapName_Route27,
    [JOHTO_MAPSEC_ROUTE_28 - JOHTO_MAPSEC_START]                   = sMapName_Route28,
    [JOHTO_MAPSEC_ROUTE_32_FLYDUP - JOHTO_MAPSEC_START]            = sMapName_Route32,
    [JOHTO_MAPSEC_ROUTE_123 - JOHTO_MAPSEC_START]                  = sMapName_Route123,
    [JOHTO_MAPSEC_ROUTE_124 - JOHTO_MAPSEC_START]                  = sMapName_Route124,
    [JOHTO_MAPSEC_ROUTE_125 - JOHTO_MAPSEC_START]                  = sMapName_Route125,
    [JOHTO_MAPSEC_ROUTE_126 - JOHTO_MAPSEC_START]                  = sMapName_Route126,
    [JOHTO_MAPSEC_ROUTE_127 - JOHTO_MAPSEC_START]                  = sMapName_Route127,
    [JOHTO_MAPSEC_ROUTE_128 - JOHTO_MAPSEC_START]                  = sMapName_Route128,
    [JOHTO_MAPSEC_ROUTE_129 - JOHTO_MAPSEC_START]                  = sMapName_Route129,
    [JOHTO_MAPSEC_ROUTE_130 - JOHTO_MAPSEC_START]                  = sMapName_Route130,
    [JOHTO_MAPSEC_ROUTE_131 - JOHTO_MAPSEC_START]                  = sMapName_Route131,
    [JOHTO_MAPSEC_ROUTE_132 - JOHTO_MAPSEC_START]                  = sMapName_Route132,
    [JOHTO_MAPSEC_ROUTE_133 - JOHTO_MAPSEC_START]                  = sMapName_Route133,
    [JOHTO_MAPSEC_ROUTE_134 - JOHTO_MAPSEC_START]                  = sMapName_Route134,
    [JOHTO_MAPSEC_UNDERWATER_124 - JOHTO_MAPSEC_START]             = sMapName_Underwater,
    [JOHTO_MAPSEC_UNDERWATER_126 - JOHTO_MAPSEC_START]             = sMapName_Underwater,
    [JOHTO_MAPSEC_UNDERWATER_127 - JOHTO_MAPSEC_START]             = sMapName_Underwater,
    [JOHTO_MAPSEC_UNDERWATER_128 - JOHTO_MAPSEC_START]             = sMapName_Underwater,
    [JOHTO_MAPSEC_UNDERWATER_SOOTOPOLIS - JOHTO_MAPSEC_START]      = sMapName_Underwater,
    [JOHTO_MAPSEC_DARK_CAVE - JOHTO_MAPSEC_START]                  = sMapName_DarkCave,
    [JOHTO_MAPSEC_SLOWPOKE_WELL - JOHTO_MAPSEC_START]              = sMapName_SlowpokeWell_B1F,
    [JOHTO_MAPSEC_SAFARI_ZONE - JOHTO_MAPSEC_START]                = sMapName_SafariZone,
    [JOHTO_MAPSEC_BATTLE_FRONTIER - JOHTO_MAPSEC_START]            = gText_BattleFrontier,
    [JOHTO_MAPSEC_ILEX_FOREST - JOHTO_MAPSEC_START]                = sMapName_IlexForest,
    [JOHTO_MAPSEC_UNION_CAVE - JOHTO_MAPSEC_START]                 = sMapName_UnionCave,
    [JOHTO_MAPSEC_SPROUT_TOWER - JOHTO_MAPSEC_START]               = sMapName_SproutTower,
    [JOHTO_MAPSEC_RUINS_OF_ALPH - JOHTO_MAPSEC_START]              = sMapName_RuinsOfAlph,
    [JOHTO_MAPSEC_ALPH_CHAMBERS - JOHTO_MAPSEC_START]              = sMapName_AlphChambers,
    [JOHTO_MAPSEC_RADIO_TOWER - JOHTO_MAPSEC_START]                = sMapName_RadioTower,
    [JOHTO_MAPSEC_MT_MORTAR - JOHTO_MAPSEC_START]                  = sMapName_MtMortar,
    [JOHTO_MAPSEC_AQUA_HIDEOUT_OLD - JOHTO_MAPSEC_START]           = sMapName_Hideout,
    [JOHTO_MAPSEC_LIGHTHOUSE - JOHTO_MAPSEC_START]                 = sMapName_Lighthouse,
    [JOHTO_MAPSEC_DRAGONS_DEN - JOHTO_MAPSEC_START]                = sMapName_DragonsDen,
    [JOHTO_MAPSEC_UNDERWATER_SEAFLOOR_CAVERN - JOHTO_MAPSEC_START] = sMapName_Underwater,
    [JOHTO_MAPSEC_VICTORY_ROAD - JOHTO_MAPSEC_START]               = sMapName_VictoryRoad,
    [JOHTO_MAPSEC_MIRAGE_ISLAND - JOHTO_MAPSEC_START]              = sMapName_MirageIsland,
    [JOHTO_MAPSEC_CAVE_OF_ORIGIN - JOHTO_MAPSEC_START]             = sMapName_CaveOfOrigin,
    [JOHTO_MAPSEC_SOUTHERN_ISLAND - JOHTO_MAPSEC_START]            = gText_SouthernIsland,
    [JOHTO_MAPSEC_LAKE_OF_RAGE - JOHTO_MAPSEC_START]               = sMapName_LakeOfRage,
    [JOHTO_MAPSEC_NATIONAL_PARK - JOHTO_MAPSEC_START]              = sMapName_NationalPark,
    [JOHTO_MAPSEC_ICE_PATH - JOHTO_MAPSEC_START]                   = sMapName_IcePath,
    [JOHTO_MAPSEC_SILVER_CAVE - JOHTO_MAPSEC_START]                = sMapName_SilverCave,
    [JOHTO_MAPSEC_SEALED_CHAMBER - JOHTO_MAPSEC_START]             = sMapName_SealedChamber,
    [JOHTO_MAPSEC_UNDERWATER_SEALED_CHAMBER - JOHTO_MAPSEC_START]  = sMapName_Underwater,
    [JOHTO_MAPSEC_SCORCHED_SLAB - JOHTO_MAPSEC_START]              = sMapName_ScorchedSlab,
    [JOHTO_MAPSEC_WHIRL_ISLANDS - JOHTO_MAPSEC_START]              = sMapName_WhirlIslands,
    [JOHTO_MAPSEC_TIN_TOWER - JOHTO_MAPSEC_START]                  = sMapName_TinTower,
    [JOHTO_MAPSEC_ANCIENT_TOMB - JOHTO_MAPSEC_START]               = sMapName_AncientTomb,
    [JOHTO_MAPSEC_INSIDE_OF_TRUCK - JOHTO_MAPSEC_START]            = sMapName_InsideOfTruck,
    [JOHTO_MAPSEC_SKY_PILLAR - JOHTO_MAPSEC_START]                 = sMapName_SkyPillar,
    [JOHTO_MAPSEC_SECRET_BASE - JOHTO_MAPSEC_START]                = sMapName_SecretBase,
    [JOHTO_MAPSEC_DYNAMIC - JOHTO_MAPSEC_START]                    = sMapName_Ferry
};
...
const u8 *const gOrreRegionMapNames[] = {
    [ORRE_MAPSEC_OUTSKIRT_STAND_1 - ORRE_MAPSEC_START]             = sMapName_OutskirtStand,
    [ORRE_MAPSEC_PHENAC_CITY_1 - ORRE_MAPSEC_START]                = sMapName_PhenacCity,
    [ORRE_MAPSEC_MAYORS_HOUSE - ORRE_MAPSEC_START]                 = sMapName_MayorsHouse,
    [ORRE_MAPSEC_CIPHER_LAB_1 - ORRE_MAPSEC_START]                 = sMapName_CipherLab,
    [ORRE_MAPSEC_CIPHER_LAB_2 - ORRE_MAPSEC_START]                 = sMapName_CipherLab,
    [ORRE_MAPSEC_CIPHER_LAB_3 - ORRE_MAPSEC_START]                 = sMapName_CipherLab,
    [ORRE_MAPSEC_CIPHER_LAB_4 - ORRE_MAPSEC_START]                 = sMapName_CipherLab,
    [ORRE_MAPSEC_PYRITE_TOWN_1 - ORRE_MAPSEC_START]                = sMapName_PyriteTown,
    [ORRE_MAPSEC_MT_BATTLE_1 - ORRE_MAPSEC_START]                  = sMapName_MtBattle,
    [ORRE_MAPSEC_PYRITE_BUILDING_1 - ORRE_MAPSEC_START]            = sMapName_PyriteBldg,
    [ORRE_MAPSEC_PYRITE_BUILDING_2 - ORRE_MAPSEC_START]            = sMapName_PyriteBldg,
    [ORRE_MAPSEC_PYRITE_CAVE_1 - ORRE_MAPSEC_START]                = sMapName_PyriteCave,
    [ORRE_MAPSEC_MIRORS_HIDEOUT - ORRE_MAPSEC_START]               = sMapName_MirorsHideout,
    [ORRE_MAPSEC_PYRITE_CAVE_2 - ORRE_MAPSEC_START]                = sMapName_PyriteCave,
    [ORRE_MAPSEC_PYRITE_CAVE_3 - ORRE_MAPSEC_START]                = sMapName_PyriteCave,
    [ORRE_MAPSEC_AGATE_VILLAGE - ORRE_MAPSEC_START]                = sMapName_AgateVillage,
    [ORRE_MAPSEC_THE_UNDER_1 - ORRE_MAPSEC_START]                  = sMapName_TheUnder,
    [ORRE_MAPSEC_THE_UNDER_2 - ORRE_MAPSEC_START]                  = sMapName_TheUnder,
    [ORRE_MAPSEC_THE_UNDER_SUBWAY - ORRE_MAPSEC_START]             = sMapName_TheUnderSubway,
    [ORRE_MAPSEC_REALGAM_TOWER_1 - ORRE_MAPSEC_START]              = sMapName_RealgamTower,
    [ORRE_MAPSEC_CIPHER_KEY_LAIR_1 - ORRE_MAPSEC_START]            = sMapName_CipherKeyLair,
    [ORRE_MAPSEC_CIPHER_KEY_LAIR_2 - ORRE_MAPSEC_START]            = sMapName_CipherKeyLair,
    [ORRE_MAPSEC_CIPHER_KEY_LAIR_3 - ORRE_MAPSEC_START]            = sMapName_CipherKeyLair,
    [ORRE_MAPSEC_LABORATORY_1 - ORRE_MAPSEC_START]                 = sMapName_Laboratory,
    [ORRE_MAPSEC_LABORATORY_2 - ORRE_MAPSEC_START]                 = sMapName_Laboratory,
    [ORRE_MAPSEC_LABORATORY_3 - ORRE_MAPSEC_START]                 = sMapName_Laboratory,
    [ORRE_MAPSEC_CIPHER_KEY_LAIR_4 - ORRE_MAPSEC_START]            = sMapName_CipherKeyLair,
    [ORRE_MAPSEC_CIPHER_KEY_LAIR_5 - ORRE_MAPSEC_START]            = sMapName_CipherKeyLair,
    [ORRE_MAPSEC_CITADARK_ISLE_1 - ORRE_MAPSEC_START]              = sMapName_CitadarkIsle,
    [ORRE_MAPSEC_CITADARK_ISLE_2 - ORRE_MAPSEC_START]              = sMapName_CitadarkIsle,
    [ORRE_MAPSEC_CITADARK_ISLE_3 - ORRE_MAPSEC_START]              = sMapName_CitadarkIsle,
    [ORRE_MAPSEC_MT_BATTLE_2 - ORRE_MAPSEC_START]                  = sMapName_MtBattle,
    [ORRE_MAPSEC_CITADARK_ISLE_4 - ORRE_MAPSEC_START]              = sMapName_CitadarkIsle,
    [ORRE_MAPSEC_CITADARK_ISLE_5 - ORRE_MAPSEC_START]              = sMapName_CitadarkIsle,
    [ORRE_MAPSEC_CITADARK_ISLE_6 - ORRE_MAPSEC_START]              = sMapName_CitadarkIsle,
    [ORRE_MAPSEC_CITADARK_ISLE_7 - ORRE_MAPSEC_START]              = sMapName_CitadarkIsle,
    [ORRE_MAPSEC_CITADARK_ISLE_8 - ORRE_MAPSEC_START]              = sMapName_CitadarkIsle,
    [ORRE_MAPSEC_CITADARK_ISLE_9 - ORRE_MAPSEC_START]              = sMapName_CitadarkIsle,
    [ORRE_MAPSEC_CITADARK_ISLE_10 - ORRE_MAPSEC_START]             = sMapName_CitadarkIsle,
    [ORRE_METLOC_POKE_SPOT_ROCK - ORRE_MAPSEC_START]               = sMapName_Rock,
    [ORRE_METLOC_POKE_SPOT_OASIS - ORRE_MAPSEC_START]              = sMapName_Oasis,
    [ORRE_METLOC_POKE_SPOT_CAVE - ORRE_MAPSEC_START]               = gPCText_Cave,
    [ORRE_MAPSEC_PHENAC_CITY_2 - ORRE_MAPSEC_START]                = sMapName_PhenacCity,
    [ORRE_MAPSEC_PHENAC_CITY_3 - ORRE_MAPSEC_START]                = sMapName_PhenacCity,
    [ORRE_MAPSEC_PHENAC_CITY_4 - ORRE_MAPSEC_START]                = sMapName_PhenacCity,
    [ORRE_MAPSEC_PHENAC_CITY_5 - ORRE_MAPSEC_START]                = sMapName_PhenacCity,
    [ORRE_MAPSEC_REALGAM_TOWER_DOME_1 - ORRE_MAPSEC_START]         = sMapName_RealgamTwr_Dome,
    [ORRE_MAPSEC_REALGAM_TOWER_DOME_2 - ORRE_MAPSEC_START]         = sMapName_RealgamTwr_Dome,
    [ORRE_MAPSEC_PHENAC_CITY_6 - ORRE_MAPSEC_START]                = sMapName_PhenacCity,
    [ORRE_MAPSEC_REALGAM_TOWER_DOME_3 - ORRE_MAPSEC_START]         = sMapName_RealgamTwr_Dome,
    [ORRE_MAPSEC_REALGAM_TOWER_DOME_4 - ORRE_MAPSEC_START]         = sMapName_RealgamTwr_Dome,
    [ORRE_MAPSEC_REALGAM_TOWER_DOME_5 - ORRE_MAPSEC_START]         = sMapName_RealgamTwr_Dome,
    [ORRE_MAPSEC_REALGAM_TOWER_DOME_6 - ORRE_MAPSEC_START]         = sMapName_RealgamTwr_Dome,
    [ORRE_MAPSEC_REALGAM_TOWER_2 - ORRE_MAPSEC_START]              = sMapName_RealgamTower,
    [ORRE_MAPSEC_PYRITE_TOWN_2 - ORRE_MAPSEC_START]                = sMapName_PyriteTown,
    [ORRE_MAPSEC_REALGAM_TOWER_3 - ORRE_MAPSEC_START]              = sMapName_RealgamTower,
    [ORRE_MAPSEC_TOWER_COLOSSEUM - ORRE_MAPSEC_START]              = sMapName_TowerColosseum,
    [ORRE_MAPSEC_PYRITE_TOWN_3 - ORRE_MAPSEC_START]                = sMapName_PyriteTown,
    [ORRE_MAPSEC_DEEP_COLOSSEUM - ORRE_MAPSEC_START]               = sMapName_DeepColosseum,
    [ORRE_MAPSEC_PHENAC_CITY_EREADER - ORRE_MAPSEC_START]          = sMapName_PhenacCity,
    [ORRE_MAPSEC_SNAGEM_HIDEOUT_1 - ORRE_MAPSEC_START]             = sMapName_SnagemHideout,
    [ORRE_MAPSEC_SNAGEM_HIDEOUT_2 - ORRE_MAPSEC_START]             = sMapName_SnagemHideout,
    [ORRE_MAPSEC_SNAGEM_HIDEOUT_3 - ORRE_MAPSEC_START]             = sMapName_SnagemHideout,
    [ORRE_MAPSEC_POKEMON_HQ_LAB - ORRE_MAPSEC_START]               = sMapName_PokemonHQLab,
    [ORRE_MAPSEC_GATEON_PORT_1 - ORRE_MAPSEC_START]                = sMapName_GateonPort,
    [ORRE_MAPSEC_GATEON_PORT_2 - ORRE_MAPSEC_START]                = sMapName_GateonPort,
    [ORRE_MAPSEC_OUTSKIRT_STAND_2 - ORRE_MAPSEC_START]             = sMapName_OutskirtStand,
};

const u8 *const gXDOrreRegionMapNames[] = {
    [XD_ORRE_MAPSEC_CIPHER_KEY_LAIR_1 - XD_ORRE_MAPSEC_START]      = sMapName_CipherKeyLair,
    [XD_ORRE_MAPSEC_CIPHER_KEY_LAIR_2 - XD_ORRE_MAPSEC_START]      = sMapName_CipherKeyLair,
    [XD_ORRE_MAPSEC_CITADARK_ISLE - XD_ORRE_MAPSEC_START]          = sMapName_CitadarkIsle,
    [XD_ORRE_MAPSEC_PYRITE_TOWN_1 - XD_ORRE_MAPSEC_START]          = sMapName_PyriteTown,
    [XD_ORRE_MAPSEC_PYRITE_TOWN_2 - XD_ORRE_MAPSEC_START]          = sMapName_PyriteTown,
    [XD_ORRE_MAPSEC_PYRITE_TOWN_3 - XD_ORRE_MAPSEC_START]          = sMapName_PyriteTown,
};
