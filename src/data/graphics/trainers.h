...
const u16 gTrainerPalette_Expert[] = INCBIN_U16("graphics/trainers/palettes/expert.gbapal");
...
const u16 gTrainerPalette_Tuber[] = INCBIN_U16("graphics/trainers/palettes/tuber.gbapal");
