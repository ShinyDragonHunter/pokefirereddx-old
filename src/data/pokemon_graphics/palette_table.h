const struct SpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(DUGTRIO, gMonPalette_Diglett),
    ...
    SPECIES_PAL(SALAMENCE, gMonPalette_Bagon),
    SPECIES_PAL(BELDUM, gMonPalette_Beldum),
    SPECIES_PAL(METANG, gMonPalette_Beldum),
    SPECIES_PAL(METAGROSS, gMonPalette_Beldum),
    ...
    SPECIES_PAL(DUGTRIO_ALOLAN, gMonPalette_DiglettAlolan),
    ...
    SPECIES_PAL(MEWTWO_ARMORED, gMonPalette_Mewtwo),
