const struct SpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(DUGTRIO, gMonShinyPalette_Diglett),
    ...
    SPECIES_SHINY_PAL(SALAMENCE, gMonShinyPalette_Bagon),
    ...
    SPECIES_SHINY_PAL(DUGTRIO_ALOLAN, gMonShinyPalette_DiglettAlolan),
    ...
    SPECIES_SHINY_PAL(MEWTWO_ARMORED, gMonShinyPalette_Mewtwo),
