const u8 gSpeciesNames[SPECIES_COUNT][POKEMON_NAME_LENGTH + 1] = {
    [SPECIES_NONE] = _("??????????"),
    ...
    [SPECIES_RATTATA_ALOLAN] = _("RATTATA-A"),
    [SPECIES_RATICATE_ALOLAN] = _("RATICATE-A"),
    [SPECIES_RAICHU_ALOLAN] = _("RAICHU-A"),
    [SPECIES_SANDSHREW_ALOLAN] = _("SANDSHREW"),
    [SPECIES_SANDSLASH_ALOLAN] = _("SANDSLASH"),
    [SPECIES_VULPIX_ALOLAN] = _("VULPIX-A"),
    [SPECIES_NINETALES_ALOLAN] = _("NINETALES"),
    [SPECIES_DIGLETT_ALOLAN] = _("DIGLETT-A"),
    [SPECIES_DUGTRIO_ALOLAN] = _("DUGTRIO-A"),
    [SPECIES_MEOWTH_ALOLAN] = _("MEOWTH-A"),
    [SPECIES_PERSIAN_ALOLAN] = _("PERSIAN-A"),
    [SPECIES_GEODUDE_ALOLAN] = _("GEODUDE-A"),
    [SPECIES_GRAVELER_ALOLAN] = _("GRAVELER-A"),
    [SPECIES_GOLEM_ALOLAN] = _("GOLEM-A"),
    [SPECIES_PONYTA_GALARIAN] = _("PONYTA-G"),
    [SPECIES_RAPIDASH_GALARIAN] = _("RAPIDASH"),
    [SPECIES_SLOWPOKE_GALARIAN] = _("SLOWPOKE"),
    [SPECIES_SLOWBRO_GALARIAN] = _("SLOWBRO-G"),
    [SPECIES_FARFETCHD_GALARIAN] = _("FARFETCH'D"),
    [SPECIES_GRIMER_ALOLAN] = _("GRIMER-A"),
    [SPECIES_MUK_ALOLAN] = _("MUK-A"),
    [SPECIES_EXEGGUTOR_ALOLAN] = _("EXEGGUTOR"),
    [SPECIES_MAROWAK_ALOLAN] = _("MAROWAK-A"),
    [SPECIES_WEEZING_GALARIAN] = _("WEEZING-A"),
    [SPECIES_MR_MIME_GALARIAN] = _("MR. MIME-G"),
    [SPECIES_ARTICUNO_GALARIAN] = _("ARTICUNO-G"),
    [SPECIES_ZAPDOS_GALARIAN] = _("ZAPDOS-G"),
    [SPECIES_MOLTRES_GALARIAN] = _("MOLTRES-G"),
    [SPECIES_MEWTWO_ARMORED] = _("MEWTWO-A"),
    [SPECIES_SLOWKING_GALARIAN] _("SLOWKING-G"),
    [SPECIES_CORSOLA_GALARIAN] = _("CORSOLA-G"),
    [SPECIES_LUGIA_SHADOW] = _("LUGIA-S"),
    [SPECIES_ZIGZAGOON_GALARIAN] = _("ZIGZAGOON"),
    [SPECIES_LINOONE_GALARIAN] = _("LINOONE-G"),
