const u8 gJapaneseSpeciesNames[SPECIES_COUNT][JAPANESE_NAME_LENGTH + 1] = {
    ...
    [SPECIES_FARFETCHD_GALARIAN] = _("カモネギ"),
    ...
    [SPECIES_MR_MIME_GALARIAN] = _("バリヤード"),
    ...
    [SPECIES_CORSOLA_GALARIAN] = _("サニーゴ"),
    [SPECIES_LUGIA_SHADOW] = _("ルギア"),
    [SPECIES_ZIGZAGOON_GALARIAN] = _("ジグザグマ"),
    [SPECIES_LINOONE_GALARIAN] = _("マッスグマ"),
