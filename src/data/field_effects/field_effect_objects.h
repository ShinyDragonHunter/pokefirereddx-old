...
const struct SpritePalette gSpritePalette_SurfBlob = {gObjectEventPal_RedLeafOriginal, OBJ_EVENT_PAL_TAG_PLAYER_ORIGINAL};
...
const struct SpriteTemplate gFieldEffectObjectTemplate_ShadowSmall = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_PLAYER_ORIGINAL,
...
const struct SpriteFrameImage  sPicTable_RayquazaSpotlightEffect[] = {
    obj_frame_tiles(gObjectEventPic_Youngster),
};
