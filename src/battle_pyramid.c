...
{
    {FACILITY_CLASS_HOENN_HIKER, TRAINER_ENCOUNTER_MUSIC_HIKER},
    {FACILITY_CLASS_HOENN_PKMN_BREEDER_F, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_HOENN_COOLTRAINER_M, TRAINER_ENCOUNTER_MUSIC_COOL},
    {FACILITY_CLASS_HOENN_BIRD_KEEPER, TRAINER_ENCOUNTER_MUSIC_COOL},
    {FACILITY_CLASS_HOENN_COLLECTOR, TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_HOENN_SWIMMER_M, TRAINER_ENCOUNTER_MUSIC_SWIMMER},
    {FACILITY_CLASS_HOENN_EXPERT_M, TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_HOENN_BLACK_BELT, TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_HOENN_HEX_MANIAC, TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_HOENN_AROMA_LADY, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_HOENN_RUIN_MANIAC, TRAINER_ENCOUNTER_MUSIC_HIKER},
    {FACILITY_CLASS_HOENN_TUBER_M, TRAINER_ENCOUNTER_MUSIC_GIRL},
    {FACILITY_CLASS_HOENN_TUBER_F, TRAINER_ENCOUNTER_MUSIC_GIRL},
    {FACILITY_CLASS_HOENN_COOLTRAINER_F, TRAINER_ENCOUNTER_MUSIC_COOL},
    {FACILITY_CLASS_HOENN_LADY, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_HOENN_BEAUTY, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_HOENN_RICH_BOY, TRAINER_ENCOUNTER_MUSIC_RICH},
    {FACILITY_CLASS_HOENN_EXPERT_F, TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_HOENN_POKEMANIAC, TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_HOENN_GUITARIST, TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_HOENN_KINDLER, TRAINER_ENCOUNTER_MUSIC_HIKER},
    {FACILITY_CLASS_HOENN_CAMPER, TRAINER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_HOENN_PICNICKER, TRAINER_ENCOUNTER_MUSIC_GIRL},
    {FACILITY_CLASS_HOENN_BUG_MANIAC, TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_HOENN_PSYCHIC_M, TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_HOENN_PSYCHIC_F, TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_HOENN_GENTLEMAN, TRAINER_ENCOUNTER_MUSIC_RICH},
    {FACILITY_CLASS_HOENN_SCHOOL_KID_M, TRAINER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_HOENN_SCHOOL_KID_F, TRAINER_ENCOUNTER_MUSIC_GIRL},
    {FACILITY_CLASS_HOENN_POKEFAN_M, TRAINER_ENCOUNTER_MUSIC_TWINS},
    {FACILITY_CLASS_HOENN_POKEFAN_F, TRAINER_ENCOUNTER_MUSIC_TWINS},
    {FACILITY_CLASS_HOENN_YOUNGSTER, TRAINER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_HOENN_FISHERMAN, TRAINER_ENCOUNTER_MUSIC_HIKER},
    {FACILITY_CLASS_HOENN_CYCLING_TRIATHLETE_M, TRAINER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_HOENN_CYCLING_TRIATHLETE_F, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_HOENN_RUNNING_TRIATHLETE_M, TRAINER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_HOENN_RUNNING_TRIATHLETE_F, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_HOENN_SWIMMING_TRIATHLETE_M, TRAINER_ENCOUNTER_MUSIC_SWIMMER},
    {FACILITY_CLASS_HOENN_SWIMMING_TRIATHLETE_F, TRAINER_ENCOUNTER_MUSIC_SWIMMER},
    {FACILITY_CLASS_HOENN_DRAGON_TAMER, TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_HOENN_NINJA_BOY, TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_HOENN_BATTLE_GIRL, TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_HOENN_PARASOL_LADY, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_HOENN_SWIMMER_F, TRAINER_ENCOUNTER_MUSIC_SWIMMER},
    {FACILITY_CLASS_HOENN_SAILOR, TRAINER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_HOENN_PKMN_BREEDER_M, TRAINER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_HOENN_BUG_CATCHER, TRAINER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_HOENN_PKMN_RANGER_M, TRAINER_ENCOUNTER_MUSIC_COOL},
    {FACILITY_CLASS_HOENN_PKMN_RANGER_F, TRAINER_ENCOUNTER_MUSIC_COOL},
    {FACILITY_CLASS_HOENN_LASS, TRAINER_ENCOUNTER_MUSIC_FEMALE},
};

static const u8 sTrainerTextGroups[50][2] =
{
    {FACILITY_CLASS_HOENN_HIKER, 4},
    {FACILITY_CLASS_HOENN_PKMN_BREEDER_F, 3},
    {FACILITY_CLASS_HOENN_COOLTRAINER_M, 2},
    {FACILITY_CLASS_HOENN_BIRD_KEEPER, 2},
    {FACILITY_CLASS_HOENN_COLLECTOR, 2},
    {FACILITY_CLASS_HOENN_SWIMMER_M, 2},
    {FACILITY_CLASS_HOENN_EXPERT_M, 4},
    {FACILITY_CLASS_HOENN_BLACK_BELT, 4},
    {FACILITY_CLASS_HOENN_HEX_MANIAC, 3},
    {FACILITY_CLASS_HOENN_AROMA_LADY, 3},
    {FACILITY_CLASS_HOENN_RUIN_MANIAC, 4},
    {FACILITY_CLASS_HOENN_TUBER_M, 0},
    {FACILITY_CLASS_HOENN_TUBER_F, 1},
    {FACILITY_CLASS_HOENN_COOLTRAINER_F, 3},
    {FACILITY_CLASS_HOENN_LADY, 3},
    {FACILITY_CLASS_HOENN_BEAUTY, 3},
    {FACILITY_CLASS_HOENN_RICH_BOY, 2},
    {FACILITY_CLASS_HOENN_EXPERT_F, 5},
    {FACILITY_CLASS_HOENN_POKEMANIAC, 2},
    {FACILITY_CLASS_HOENN_GUITARIST, 2},
    {FACILITY_CLASS_HOENN_KINDLER, 2},
    {FACILITY_CLASS_HOENN_CAMPER, 0},
    {FACILITY_CLASS_HOENN_PICNICKER, 1},
    {FACILITY_CLASS_HOENN_BUG_MANIAC, 2},
    {FACILITY_CLASS_HOENN_PSYCHIC_M, 2},
    {FACILITY_CLASS_HOENN_PSYCHIC_F, 3},
    {FACILITY_CLASS_HOENN_GENTLEMAN, 4},
    {FACILITY_CLASS_HOENN_SCHOOL_KID_M, 0},
    {FACILITY_CLASS_HOENN_SCHOOL_KID_F, 1},
    {FACILITY_CLASS_HOENN_POKEFAN_M, 4},
    {FACILITY_CLASS_HOENN_POKEFAN_F, 5},
    {FACILITY_CLASS_HOENN_YOUNGSTER, 0},
    {FACILITY_CLASS_HOENN_FISHERMAN, 4},
    {FACILITY_CLASS_HOENN_CYCLING_TRIATHLETE_M, 2},
    {FACILITY_CLASS_HOENN_CYCLING_TRIATHLETE_F, 3},
    {FACILITY_CLASS_HOENN_RUNNING_TRIATHLETE_M, 2},
    {FACILITY_CLASS_HOENN_RUNNING_TRIATHLETE_F, 3},
    {FACILITY_CLASS_HOENN_SWIMMING_TRIATHLETE_M, 2},
    {FACILITY_CLASS_HOENN_SWIMMING_TRIATHLETE_F, 3},
    {FACILITY_CLASS_HOENN_DRAGON_TAMER, 2},
    {FACILITY_CLASS_HOENN_NINJA_BOY, 0},
    {FACILITY_CLASS_HOENN_BATTLE_GIRL, 3},
    {FACILITY_CLASS_HOENN_PARASOL_LADY, 3},
    {FACILITY_CLASS_HOENN_SWIMMER_F, 3},
    {FACILITY_CLASS_HOENN_SAILOR, 2},
    {FACILITY_CLASS_HOENN_PKMN_BREEDER_M, 2},
    {FACILITY_CLASS_HOENN_BUG_CATCHER, 0},
    {FACILITY_CLASS_HOENN_PKMN_RANGER_M, 2},
    {FACILITY_CLASS_HOENN_PKMN_RANGER_F, 3},
    {FACILITY_CLASS_HOENN_LASS, 3},
};
...
u8 GetBattlePyramindTrainerEncounterMusicId(u16 trainerId)
{
    ...
    {
        if (sTrainerClassEncounterMusic[i].trainerClass == gFacilityTrainers[trainerId].facilityClass)
