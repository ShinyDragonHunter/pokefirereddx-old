...
bool32 HandleMysteryGiftOrEReaderSetup(s32 mg_or_ereader)
{
    ...
    case 1:
        ...
        LoadThinWindowBorderGfx(0, 0x1, 0xF0);
...
static const u8 * mevent_message(u32 * a0, u8 a1, u8 cardOrNews, u32 msgId)
{
    ...
    *a0 = 0;
    ...
    case 2:
        *a0 = 1;
        msg = cardOrNews ? gText_WonderCardReceivedFrom : gText_WonderCardReceived;
        break;
    case 3:
        *a0 = 1;
        msg = cardOrNews ? gText_WonderNewsReceivedFrom : gText_WonderNewsReceived;
        break;
    case 4:
        *a0 = 1;
    ...
    case 10:
        *a0 = 0;
        msg = a1 ? gText_CantAcceptNewsFromTrainer : gText_CantAcceptCardFromTrainer;
        break;
    case 11:
        *a0 = 0;
...
void task00_mystery_gift(u8 taskId)
{
    ...
    case 22:
        ...
        {
        case 0:
            if (!data->IsCardOrNews && CheckReceivedGiftFromWonderCard())
            {
                data->state = 23;
            }
            else
